...
<TIBCOInstallerFeatures>
	...
	<productDef name="TIBCO BusinessEvents Decision Manager @BE_VERSION@" version="@BE_VERSION@" id="businessevents-decisionmanager" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@BE_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@"></productDef>
...
<featureconfigincludes>
	...
	<installerFeature name="Decision Manager" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="Studio_businessevents-decisionmanager" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="Eclipse_businessevents-decisionmanager" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Server_businessevents-decisionmanager" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	...
	<installerFeature name="Studio" version="@BE_VERSION@" visible="false" dependencyOperator="OR">
		<dependency description="TIBCO BusinessEvents Studio" type="feature" uid="TIBCO BusinessEvents Studio_businessevents-standard" version="@BE_VERSION@"/>
	...
	<installerFeature name="Eclipse" version="@BE_VERSION@" visible="false" dependencyOperator="OR">
		<dependency description="Eclipse Platform" type="feature" uid="Eclipse Platform_businessevents-standard" version="@BE_VERSION@"/>
