...
<TIBCOInstallerFeatures>
	...
	<productDef name="TIBCO BusinessEvents Process Orchestration @BE_BPMN_VERSION@" version="@BE_BPMN_VERSION@" id="businessevents-process" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@PROCESS_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@"></productDef>
    ...
    <featureconfigincludes>
        ...
        <featureconfiginclude featureconfigname="contrib_be-process-modeler_@BE_BPMN_VERSION@_FeatureConfig.xml" plat="win_x86,win_x86_64,linux_x86,linux_x86_64,sol_sparc,hpux_ia64,sol_sparc_64,sol_x86_64,aix_power_64,linux_s390x,macos_x86_64"/>
   </featureconfigincludes>
    
	<installerFeature name="Process Orchestration Server" visible="true" version="@BE_BPMN_VERSION@">
		...
		<dependency type="feature" uid="Server_businessevents-standard" parentID="businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	</installerFeature>
	
	<installerFeature name="Process Modeler" visible="true" version="@BE_BPMN_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="TIBCO BusinessEvents Studio_businessevents-standard" parentID="businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="Eclipse Platform_businessevents-standard" parentID="businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Server_businessevents-standard" parentID="businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	</installerFeature>
	
	<installerFeature name="Examples" installLocation="$L{be.product.home}" visible="true" version="@BE_BPMN_VERSION@">
		<assemblyList>
