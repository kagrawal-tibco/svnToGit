...
<TIBCOInstallerFeatures>
	...
	<productDef name="TIBCO BusinessEvents Data Modeling @BE_VERSION@" version="@BE_VERSION@" id="businessevents-datamodeling" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@BE_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@"></productDef>
   ...
   <featureconfigincludes>
	...
	<installerFeature name="State Modeler" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="TIBCO BusinessEvents Studio_businessevents-standard" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="Eclipse Platform_businessevents-standard" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Server_businessevents-standard" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	</installerFeature>
