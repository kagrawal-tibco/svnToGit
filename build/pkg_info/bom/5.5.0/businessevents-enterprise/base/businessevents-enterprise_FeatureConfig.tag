   ...
   <!-- <documentation>
    ...
    <featureconfigincludes>
		...
		<!--<featureconfiginclude featureconfigname="contrib_activespaces-runtimedummy_@AS_VERSION@.0@AS_BUILD_VERSION@_FeatureConfig.xml" />-->
		 ...
		 <!-- JRE Includes -->
  		<featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/java/1.8" featureconfigname="contrib_tibcojava64-hpux_1.8.0.152_FeatureConfig.xml" plat="hpux_ia64"/>
		<featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/java/1.8" featureconfigname="contrib_tibcojava64-ibm_1.8.0.151_FeatureConfig.xml" plat="aix_power_64,linux_s390x"/>
		<featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/java/1.8" featureconfigname="contrib_tibcojava-oracle_1.8.0.162_FeatureConfig.xml" plat="sol_sparc,sol_x86"/>
		<featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/java/1.8" featureconfigname="contrib_tibcojava-oracle_1.8.0.162_FeatureConfig.xml" plat="win_x86,linux_x86"/>
		<featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/java/1.8" featureconfigname="contrib_tibcojava64-oracle_1.8.0.162_FeatureConfig.xml" plat="win_x86_64,linux_x86_64,sol_sparc_64,sol_x86_64,macos_x86_64"/>
	...
	<installerFeature name="TIBCO BusinessEvents Studio" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="Server_businessevents-enterprise" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	...
	<installerFeature name="TIBCO BusinessEvents DataGrid" visible="true" version="@BE_VERSION@" plat="win_x86,win_x86_64,linux26gl25_x86,linux26gl25_x86_64,sol10_sparc,sol10_x86,hpux111_hppa,aix61_power,hpux112_ia64,sol10_sparc_64,sol10_x86_64,aix61_power_64,hpux111_hppa_64,linux26gl24_s390x,macos_x86_64">
...
<!-- 		</wizardAction> -->
	...
	<installerFeature name="Enterprise Administrator Agent" visible="true" version="@BE_VERSION@">
	...
	<installerFeature name="Examples" installLocation="$L{be.product.home}" visible="true" version="@BE_VERSION@">
		...
		<dependency type="feature" uid="Server_businessevents-enterprise"  mustBeInstalled="false" version="5.0.0" description="TIBCO BusinessEvents Server" />				
    ...
    <installerFeature name="Rules Management Server" visible="true" version="@BE_VERSION@">
	...
	<installerFeature name="Server" visible="false" version="@BE_VERSION@">
		...
		<dependency type="feature" uid="TIBCO BusinessEvents Studio_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="TIBCO BusinessEvents DataGrid_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents DataGrid" />
		<dependency type="feature" uid="Monitoring and Management_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Monitoring and Management" />
		<dependency type="feature" uid="Enterprise Administrator Agent_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Enterprise Administrator Agent" />
		<dependency type="feature" uid="Eclipse Platform_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Examples_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Examples" />
		<dependency type="feature" uid="Rules Management Server_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="Rules Management Server" />
		<dependency type="feature" uid="Server_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	...
	<installerFeature name="Database Concepts" visible="true" version="@BE_VERSION@">
		...
		<dependency type="feature" uid="Server_businessevents-enterprise" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	</installerFeature>
        
	<installerFeature name="State Modeler" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="TIBCO BusinessEvents Studio_businessevents-enterprise" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="Eclipse Platform_businessevents-enterprise" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Server_businessevents-enterprise" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	</installerFeature>
...
-->
	...
	<installerFeature name="Decision Manager" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="Studio_businessevents-enterprise" version="@BE_VERSION@" description="TIBCO BusinessEvents Studio" />
		<dependency type="feature" uid="Eclipse_businessevents-enterprise" version="@BE_VERSION@" description="Eclipse Platform" />
		<dependency type="feature" uid="Server_businessevents-enterprise" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
		<wizardAction class="com.tibco.installer.wizard.action.TIBCOCreateWindowsShortcutWizardAction" sequence="post-install">
			<property shortcutFolder="TIBCO/${tibco.environment.name}/TIBCO BusinessEvents $L{be.shortVersion}" />
...
<!--     
	...
	<installerFeature name="Server" version="@BE_VERSION@" visible="false" dependencyOperator="OR">
		<dependency description="TIBCO BusinessEvents Server" type="feature" uid="Server_businessevents-standard" version="@BE_VERSION@"/>
	...
	<installerFeature name="Live DataMart Plugin" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
	...
	<installerFeature name="Studio" version="@BE_VERSION@" visible="false" dependencyOperator="OR">
		<dependency description="TIBCO BusinessEvents Studio" type="feature" uid="TIBCO BusinessEvents Studio_businessevents-enterprise" version="@BE_VERSION@"/>
		<dependency description="TIBCO BusinessEvents Studio" type="feature" uid="TIBCO BusinessEvents Studio_businessevents-express" version="@BE_VERSION@"/>
	</installerFeature>
	
	<installerFeature name="Eclipse" version="@BE_VERSION@" visible="false" dependencyOperator="OR">
		<dependency description="Eclipse Platform" type="feature" uid="Eclipse Platform_businessevents-enterprise" version="@BE_VERSION@"/>
		<dependency description="Eclipse Platform" type="feature" uid="Eclipse Platform_businessevents-express" version="@BE_VERSION@"/>
	</installerFeature>
