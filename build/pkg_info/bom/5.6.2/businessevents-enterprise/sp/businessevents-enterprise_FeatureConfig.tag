...
<TIBCOInstallerFeatures>
   ...
   <!-- <documentation>
    ...
    <featureconfigincludes>
		...
		<!-- Wrapper Includes -->
        <featureconfiginclude svnrev="HEAD" svnurlloc="http://svn.tibco.com/install/trunk/contribs/wrapper/2.4" featureconfigname="contrib_wrapper_2.4.3_FeatureConfig.xml" plat="win_x86_64,linux_x86_64,macos_x86_64,sol_sparc_64"/>
        ...
        <!-- Standard Includes -->
        <featureconfiginclude featureconfigname="contrib_be-teagent_@BE_VERSION@_FeatureConfig.xml" plat="win_x86_64,linux_x86_64,macos_x86_64,sol_sparc_64"/>
	...
	<installerFeature name="TIBCO BusinessEvents DataGrid SP @BE_VERSION_UPDATE@" visible="true" version="@BE_VERSION@" plat="win_x86_64,linux_x86_64,macos_x86_64,sol_sparc_64">
...
-->
<installerFeature name="Oracle Elliptic Curve Cryptography Library SP @BE_VERSION_UPDATE@" version="@BE_VERSION@" visible="true">
