...
<TIBCOInstallerFeatures>
    <productDef productType="contributor-servicepack" name="be-server" id="be-server" version="@BE_VERSION@.@BE_BUILD@" />
	...
	<installerFeature name="be-server" visible="false" version="@BE_VERSION@.@BE_BUILD@">
		<assemblyList>
			...
			<dependency type="feature" uid="main_wrapper" version="2.4.1" description="Wrapper" plat="win_x86,linux_x86,sol_sparc,sol_x86,hpux_hppa,aix_power,win_x86_64,linux_x86_64,hpux_ia64,sol_sparc_64,sol_x86_64,hpux_hppa_64,aix_power_64,linux_s390x,macos_x86_64" />
			<dependency type="feature" uid="main_tibcojava64-hpux" version="1.7.0" description="JRE for HPUX" plat="hpux_ia64"/>
			<dependency type="feature" uid="main_tibcojava-ibm"  version="1.7.0" description="32bit IBM JRE" plat="aix_power"/>
			<dependency type="feature" uid="main_tibcojava64-ibm" version="1.7.0" description="64bit IBM JRE" plat="aix_power_64,linux_s390x"/>
			<dependency type="feature" uid="main_tibcojava-oracle" version="1.7.0" description="32bit Oracle JRE" plat="win_x86,linux_x86,sol_sparc,sol_x86"/>
			<dependency type="feature" uid="main_tibcojava64-oracle" version="1.7.0" description="64bit Oracle JRE" plat="win_x86_64,linux_x86_64,sol_sparc_64,sol_x86_64,macos_x86_64"/>
		</assemblyList>
