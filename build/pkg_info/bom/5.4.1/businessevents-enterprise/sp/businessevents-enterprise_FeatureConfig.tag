...
<!-- 		</wizardAction> -->
	...
	<installerFeature name="Server SP @BE_VERSION_UPDATE@" visible="false" version="@BE_VERSION@">
		...
		<dependency type="feature" uid="DataGrid SP @BE_VERSION_UPDATE@_businessevents-standard" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents DataGrid" />
