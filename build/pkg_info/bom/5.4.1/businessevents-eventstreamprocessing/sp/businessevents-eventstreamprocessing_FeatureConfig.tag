...
<TIBCOInstallerFeatures>
	...
	<productDef name="TIBCO BusinessEvents Event Stream Processing @BE_VERSION@" version="@BE_VERSION@" id="businessevents-eventstreamprocessing" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@BE_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@" productType="servicepack"></productDef>
