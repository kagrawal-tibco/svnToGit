...
<!--
 !
 ! $HeadURL: http://svn.tibco.com/be/branches/5.2/build/pkg_info/bom/5.2.0/base/contrib_be-query_5.2.0_FeatureConfig.tag $
...
<TIBCOInstallerFeatures>
    <productDef productType="contributor-servicepack" name="be-query" id="be-query" version="@BE_VERSION@.@BE_BUILD@" />
    ...
    <installerFeature name="be-query" installLocation="$L{be.product.home}" visible="false" version="@BE_VERSION@.@BE_BUILD@">
		<assemblyList>
			<assembly uid="product_tibco_be_query" version="@BE_VERSION@.@BE_BUILD@"/>
		</assemblyList>
   </installerFeature>
