...
<TIBCOInstallerFeatures>
    <productDef productType="contributor-servicepack" name="be-views-modeler" id="be-views-modeler" version="@BE_VERSION@.@BE_BUILD@" />
    ...
    <installerFeature visible="false" name="be-views-modeler" installLocation="$L{be.product.home}" version="@BE_VERSION@.@BE_BUILD@"  plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<postInstallAction sequence="post-assembly-ref" target="post-install" taskFile="${TIBCO_HOME}/be/@BE_VERSION_MAJOR@.@BE_VERSION_MINOR@/uninstaller_scripts/post-views_modeler-install.xml" description="Performing post-installation tasks for BusinessEvents Views Modeler"/>
		<postInstallAction sequence="pre-uninstall-ref" target="pre-uninstall" taskFile="${TIBCO_HOME}/be/@BE_VERSION_MAJOR@.@BE_VERSION_MINOR@/uninstaller_scripts/pre-views_modeler-uninstall.xml" description="Performing pre-uninstallation tasks for BusinessEvents Views Modeler"/>
	</installerFeature>
