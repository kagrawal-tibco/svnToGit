...
<TIBCOInstallerFeatures>
	<productDef name="TIBCO BusinessEvents @BE_VERSION@" version="@BE_VERSION@" id="businessevents-express" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@EXPRESS_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@" productType="servicepack"></productDef>
	...
	<installerFeature name="TIBCO BusinessEvents Studio SP @BE_VERSION_UPDATE@" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
		...
		<dependency type="feature" uid="Server SP @BE_VERSION_UPDATE@_businessevents-express" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />
	...
	<installerFeature name="Examples SP @BE_VERSION_UPDATE@" installLocation="$L{be.product.home}" visible="true" version="@BE_VERSION@">
		...
		<dependency type="feature" uid="Server SP @BE_VERSION_UPDATE@_businessevents-express" parentID="businessevents-express" mustBeInstalled="false" version="@BE_VERSION@" description="TIBCO BusinessEvents Server" />		
