...
<TIBCOInstallerFeatures>
	...
	<productDef name="TIBCO BusinessEvents Views @BE_VERSION@" version="@BE_VERSION@" id="businessevents-views" releaseType="@BE_RELEASE_TYPE@" supportedPlatforms="@BE_SUPPORTED_PLATFORMS@" universalinstallerrelease="@INSTALLER_RELEASE@" universalinstallerversion="@INSTALLER_VERSION@"></productDef>
   ...
   <featureconfigincludes>
    ...
    <installerFeature name="Server" visible="true" version="@BE_VERSION@">
    ...
    <installerFeature name="Modeler" visible="true" version="@BE_VERSION@" plat="@BE_DESIGNTIME_PLATFORMS@">
