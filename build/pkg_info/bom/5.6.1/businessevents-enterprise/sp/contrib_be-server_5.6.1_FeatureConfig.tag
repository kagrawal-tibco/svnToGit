...
<TIBCOInstallerFeatures>
	...
	<installerFeature name="be-server" visible="false" version="@BE_VERSION@.@BE_BUILD@">
		<assemblyList>
			...
			<dependency type="feature" uid="main_wrapper" version="2.4.1" description="Wrapper" plat="win_x86_64,linux_x86_64,sol_sparc_64,sol_x86_64,macos_x86_64,hpux_ia64,aix_power_64,linux_s390x" />
			...
			<dependency type="feature" uid="main_tibcojava64-oracle" version="1.7.0" description="64bit Oracle JRE" plat="sol_x86_64"/>
		</assemblyList>
		...
		<postInstallAction sequence="pre-uninstall-ref" target="pre-uninstall" taskFile="${TIBCO_HOME}/be/@BE_VERSION_MAJOR@.@BE_VERSION_MINOR@/uninstaller_scripts/pre-server-uninstall.xml" description="Performing pre-uninstallation tasks for BusinessEvents Server"/>
	</installerFeature>
