 ...
 * $Id$
 */
package com.tibco.cep.decision.tree.common.model.edge.util;
 ...
 * <!-- end-user-doc -->
 * @see com.tibco.cep.decision.tree.common.model.edge.EdgePackage
 * @generated
 */
public class EdgeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EdgePackage.EDGE: {
				Edge edge = (Edge)theEObject;
				T result = caseEdge(edge);
				if (result == null) result = caseFlowElement(edge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EdgePackage.ASSOCIATION: {
				Association association = (Association)theEObject;
				T result = caseAssociation(association);
				if (result == null) result = caseEdge(association);
				if (result == null) result = caseFlowElement(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
