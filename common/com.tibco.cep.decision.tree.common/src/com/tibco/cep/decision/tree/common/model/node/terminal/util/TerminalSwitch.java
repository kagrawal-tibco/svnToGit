 ...
 * @generated
 */
public class TerminalSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TerminalPackage.TERMINAL: {
				Terminal terminal = (Terminal)theEObject;
				T result = caseTerminal(terminal);
				if (result == null) result = caseNodeElement(terminal);
				if (result == null) result = caseFlowElement(terminal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerminalPackage.START: {
				Start start = (Start)theEObject;
				T result = caseStart(start);
				if (result == null) result = caseTerminal(start);
				if (result == null) result = caseNodeElement(start);
				if (result == null) result = caseFlowElement(start);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerminalPackage.END: {
				End end = (End)theEObject;
				T result = caseEnd(end);
				if (result == null) result = caseTerminal(end);
				if (result == null) result = caseNodeElement(end);
				if (result == null) result = caseFlowElement(end);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TerminalPackage.BREAK: {
				Break break_ = (Break)theEObject;
				T result = caseBreak(break_);
				if (result == null) result = caseTerminal(break_);
				if (result == null) result = caseNodeElement(break_);
				if (result == null) result = caseFlowElement(break_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
