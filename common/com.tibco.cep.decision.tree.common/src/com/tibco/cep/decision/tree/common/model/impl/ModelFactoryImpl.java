...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public static ModelFactory init() {
		try {
			ModelFactory theModelFactory = (ModelFactory)EPackage.Registry.INSTANCE.getEFactory("http:///com/tibco/cep/decision/tree/model/DecisionTree.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ModelPackage.DECISION_TREE: return createDecisionTree();
			case ModelPackage.FLOW_ELEMENT: return createFlowElement();
			default:
