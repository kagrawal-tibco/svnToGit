 ...
 * $Id$
 */
package com.tibco.cep.decision.tree.common.model.node.terminal.util;
 ...
 * <!-- end-user-doc -->
 * @see com.tibco.cep.decision.tree.common.model.node.terminal.TerminalPackage
 * @generated
 */
public class TerminalAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static TerminalPackage modelPackage;
	 ...
	 * @generated
	 */
	public TerminalAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = TerminalPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected TerminalSwitch<Adapter> modelSwitch =
		new TerminalSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decision.tree.common.model.node.terminal.Terminal <em>Terminal</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decision.tree.common.model.node.terminal.Start <em>Start</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decision.tree.common.model.node.terminal.End <em>End</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decision.tree.common.model.node.terminal.Break <em>Break</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
