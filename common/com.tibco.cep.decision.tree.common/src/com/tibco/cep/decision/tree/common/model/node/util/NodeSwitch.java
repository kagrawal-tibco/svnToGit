...
public class NodeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NodePackage.NODE_ELEMENT: {
				NodeElement nodeElement = (NodeElement)theEObject;
				T result = caseNodeElement(nodeElement);
				if (result == null) result = caseFlowElement(nodeElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodePackage.LOOP: {
				Loop loop = (Loop)theEObject;
				T result = caseLoop(loop);
				if (result == null) result = caseNodeElement(loop);
				if (result == null) result = caseFlowElement(loop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodePackage.DESCRIPTION_ELEMENT: {
				DescriptionElement descriptionElement = (DescriptionElement)theEObject;
				T result = caseDescriptionElement(descriptionElement);
				if (result == null) result = caseNodeElement(descriptionElement);
				if (result == null) result = caseFlowElement(descriptionElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
