 ...
 * <ul>
 *   <li>{@link com.tibco.cep.studio.core.functions.impl.CatalogImpl#getCategory <em>Category</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CatalogImpl extends EObjectImpl implements Catalog {
	...
	protected EClass eStaticClass() {
		return FunctionsPackage.Literals.CATALOG;
	}
	...
	public EList<Category> getCategory() {
		if (category == null) {
			category = new EObjectContainmentEList<Category>(Category.class, this, FunctionsPackage.CATALOG__CATEGORY);
		}
		return category;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FunctionsPackage.CATALOG__CATEGORY:
