...
public class DashboardAgentToBusinessEventsArchiveAdapter
        extends BusinessEventsArchiveResourceImpl {


    protected final ClusterConfig clusterConfig;
    protected final DashboardAgentClassConfig agentGroupConfig;
    protected final ObjectManagerAdapter objectManagerAdapter;


    public DashboardAgentToBusinessEventsArchiveAdapter(
    ...
    public DashboardAgentClassConfig getAgentGroupConfig() {
