...
public class QueryAgentToBusinessEventsArchiveAdapter
        extends BusinessEventsArchiveResourceImpl {


    protected final ClusterConfig clusterConfig;
    protected final QueryAgentClassConfig agentGroupConfig;
    protected final ObjectManagerAdapter objectManagerAdapter;


    public QueryAgentToBusinessEventsArchiveAdapter(
        ...
        this.objectManagerAdapter = new ObjectManagerAdapter(
        		config.getObjectManagement().getCacheManager());
        super.setName(agentKey);
        super.setArchiveType(BE_ARCHIVE_TYPE.QUERY);
    }
    ...
    protected QueryAgentClassConfig getAgentGroupConfig() {
    ...
    public EList<InputDestination> getInputDestinations() {
        return this.getInputDestinations(this.agentGroupConfig.getDestinations());
    }
    ...
    protected EList<InputDestination> getInputDestinations(
        ...
        final EList<InputDestination> inputDestinationConfigs =
                new EObjectContainmentEList<InputDestination>(InputDestination.class, this,
