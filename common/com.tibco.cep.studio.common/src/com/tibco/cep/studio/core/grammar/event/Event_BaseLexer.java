...
// $ANTLR 3.2 Sep 23, 2009 12:02:23 BaseLexer.g 2014-03-26 14:10:37
...
public class Event_BaseLexer extends Lexer {
    ...
    // delegates
    // delegators
    public EventLexer gEvent;
    public EventLexer gParent;

    public Event_BaseLexer() {;} 
    public Event_BaseLexer(CharStream input, EventLexer gEvent) {
        this(input, new RecognizerSharedState(), gEvent);
    }
    public Event_BaseLexer(CharStream input, RecognizerSharedState state, EventLexer gEvent) {
        super(input,state);
