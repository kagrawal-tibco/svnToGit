 ...
 * <ul>
 *   <li>{@link com.tibco.cep.studio.core.index.model.impl.TypeElementImpl#getFolder <em>Folder</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class TypeElementImpl extends DesignerElementImpl implements TypeElement {
	/**
	...
	protected EClass eStaticClass() {
		return IndexPackage.Literals.TYPE_ELEMENT;
	}
	...
	public void setFolder(String newFolder) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IndexPackage.TYPE_ELEMENT__FOLDER, oldFolder, folder));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IndexPackage.TYPE_ELEMENT__FOLDER:
				return getFolder();
		}
