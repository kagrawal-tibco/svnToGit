...
public class PaletteSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PalettePackage.PALETTE_MODEL: {
				PaletteModel paletteModel = (PaletteModel)theEObject;
				T result = casePaletteModel(paletteModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePaletteModel(PaletteModel object) {
		return null;
	}
