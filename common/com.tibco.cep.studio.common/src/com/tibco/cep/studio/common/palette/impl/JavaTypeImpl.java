 ...
 * <ul>
 *   <li>{@link com.tibco.cep.studio.common.palette.impl.JavaTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JavaTypeImpl extends EObjectImpl implements JavaType {
	...
	protected EClass eStaticClass() {
		return PalettePackage.Literals.JAVA_TYPE;
	}
	...
	public EList<String> getType() {
		if (type == null) {
			type = new EDataTypeEList<String>(String.class, this, PalettePackage.JAVA_TYPE__TYPE);
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PalettePackage.JAVA_TYPE__TYPE:
				return getType();
		}
