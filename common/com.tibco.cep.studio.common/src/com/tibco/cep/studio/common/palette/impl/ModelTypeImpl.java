 ...
 * <ul>
 *   <li>{@link com.tibco.cep.studio.common.palette.impl.ModelTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelTypeImpl extends EObjectImpl implements ModelType {
	...
	protected EClass eStaticClass() {
		return PalettePackage.Literals.MODEL_TYPE;
	}
	...
	public EList<String> getType() {
		if (type == null) {
			type = new EDataTypeEList<String>(String.class, this, PalettePackage.MODEL_TYPE__TYPE);
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PalettePackage.MODEL_TYPE__TYPE:
				return getType();
		}
