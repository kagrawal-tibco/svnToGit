...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.SIMPLE_PROPERTY: {
				SimpleProperty simpleProperty = (SimpleProperty)theEObject;
				T result = caseSimpleProperty(simpleProperty);
				if (result == null) result = caseEntity(simpleProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.OBJECT_PROPERTY: {
			...
			case ModelPackage.RULE_PARTICIPANT: {
				RuleParticipant ruleParticipant = (RuleParticipant)theEObject;
				T result = caseRuleParticipant(ruleParticipant);
				if (result == null) result = caseEntity(ruleParticipant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.PROPERTY_MAP: {
