 ...
 * <!-- end-user-doc -->
 * @see com.tibco.cep.designtime.core.model.ModelPackage#getTIME_UNITS()
 * @model
 * @generated
 */
public enum TIME_UNITS implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final TIME_UNITS[] VALUES_ARRAY =
		new TIME_UNITS[] {
			MILLISECONDS,
			SECONDS,
			MINUTES,
	 ...
	 * @generated
	 */
	public static final List<TIME_UNITS> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static TIME_UNITS get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TIME_UNITS result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TIME_UNITS getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			TIME_UNITS result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static TIME_UNITS get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private TIME_UNITS(int value, String name, String literal) {
		this.value = value;
		this.name = name;
