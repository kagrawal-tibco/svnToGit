...
public class JavaFactoryImpl extends EFactoryImpl implements JavaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case JavaPackage.JAVA_SOURCE: return createJavaSource();
			case JavaPackage.JAVA_RESOURCE: return createJavaResource();
			default:
	...
	public JavaSource createJavaSource() {
		JavaSourceImpl javaSource = new JavaSourceImpl();
		return javaSource;
	}
