 ...
 * $Id$
 */
package com.tibco.cep.designtime.core.model.java.util;
...
import com.tibco.cep.designtime.core.model.java.*;
...
public class JavaAdapterFactory extends AdapterFactoryImpl {
	...
	protected JavaSwitch<Adapter> modelSwitch =
		new JavaSwitch<Adapter>() {
			@Override
			public Adapter caseJavaSource(JavaSource object) {
				return createJavaSourceAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.designtime.core.model.java.JavaSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createJavaSourceAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.designtime.core.model.java.JavaResource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
