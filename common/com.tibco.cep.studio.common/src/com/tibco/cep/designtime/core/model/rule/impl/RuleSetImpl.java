 ...
 * <ul>
 *   <li>{@link com.tibco.cep.designtime.core.model.rule.impl.RuleSetImpl#getRules <em>Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RuleSetImpl extends EntityImpl implements RuleSet {
	/**
	...
	protected EClass eStaticClass() {
		return RulePackage.Literals.RULE_SET;
	}
	...
	public EList<Rule> getRules() {
		if (rules == null) {
			rules = new EObjectResolvingEList<Rule>(Rule.class, this, RulePackage.RULE_SET__RULES);
		}
		return rules;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RulePackage.RULE_SET__RULES:
				return getRules();
		}
