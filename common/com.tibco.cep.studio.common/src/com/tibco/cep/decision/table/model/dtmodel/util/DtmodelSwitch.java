 ...
 * @generated
 */
public class DtmodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DtmodelPackage.ARGUMENT: {
				Argument argument = (Argument)theEObject;
				T result = caseArgument(argument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.TABLE_RULE_SET: {
				TableRuleSet tableRuleSet = (TableRuleSet)theEObject;
				T result = caseTableRuleSet(tableRuleSet);
				if (result == null) result = caseMetadatable(tableRuleSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.TABLE_RULE: {
				TableRule tableRule = (TableRule)theEObject;
				T result = caseTableRule(tableRule);
				if (result == null) result = caseMetadatable(tableRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.ARGUMENT_PROPERTY: {
				ArgumentProperty argumentProperty = (ArgumentProperty)theEObject;
				T result = caseArgumentProperty(argumentProperty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = caseImplementation(table);
				if (result == null) result = caseMetadatable(table);
				if (result == null) result = caseAbstractResource(table);
				if (result == null) result = caseAccessControlCandidate(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.META_DATA: {
				MetaData metaData = (MetaData)theEObject;
				T result = caseMetaData(metaData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.TABLE_RULE_VARIABLE: {
				TableRuleVariable tableRuleVariable = (TableRuleVariable)theEObject;
				T result = caseTableRuleVariable(tableRuleVariable);
				if (result == null) result = caseAccessControlCandidate(tableRuleVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.COLUMNS: {
				Columns columns = (Columns)theEObject;
				T result = caseColumns(columns);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.COLUMN: {
				Column column = (Column)theEObject;
				T result = caseColumn(column);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DtmodelPackage.METADATABLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Table Rule Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Table Rule Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTableRuleSet(TableRuleSet object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Table Rule</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Table Rule</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTableRule(TableRule object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Argument Property</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Argument Property</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArgumentProperty(ArgumentProperty object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Table Rule Variable</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Table Rule Variable</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTableRuleVariable(TableRuleVariable object) {
		return null;
	}
