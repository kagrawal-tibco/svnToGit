 ...
 * @generated
 */
public class DecisionProjectModelAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static DecisionProjectModelPackage modelPackage;
	 ...
	 * @generated
	 */
	public DecisionProjectModelAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = DecisionProjectModelPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected DecisionProjectModelSwitch<Adapter> modelSwitch =
		new DecisionProjectModelSwitch<Adapter>() {
			@Override
			public Adapter caseDecisionProject(DecisionProject object) {
				return createDecisionProjectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decisionprojectmodel.DecisionProject <em>Decision Project</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDecisionProjectAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.cep.decisionprojectmodel.DomainModel <em>Domain Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //DecisionProjectModelAdapterFactory
