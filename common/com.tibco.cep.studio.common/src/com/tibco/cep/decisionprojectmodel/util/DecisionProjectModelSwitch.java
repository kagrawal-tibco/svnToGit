 ...
 * @generated
 */
public class DecisionProjectModelSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public DecisionProjectModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DecisionProjectModelPackage.DECISION_PROJECT: {
				DecisionProject decisionProject = (DecisionProject)theEObject;
				T result = caseDecisionProject(decisionProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DecisionProjectModelPackage.DOMAIN_MODEL: {
				DomainModel domainModel = (DomainModel)theEObject;
				T result = caseDomainModel(domainModel);
				if (result == null) result = caseAccessControlCandidate(domainModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Decision Project</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Decision Project</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDecisionProject(DecisionProject object) {
		return null;
	}
