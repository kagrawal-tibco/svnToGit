 ...
 * <ul>
 *   <li>{@link com.tibco.cep.decisionproject.ontology.impl.OntologyImpl#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OntologyImpl extends ParentResourceImpl implements Ontology {
	/**
	...
	public EList<AbstractResource> getResource() {
		if (resource == null) {
			resource = new EObjectResolvingEList<AbstractResource>(AbstractResource.class, this, OntologyPackage.ONTOLOGY__RESOURCE);
		}
		return resource;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntologyPackage.ONTOLOGY__RESOURCE:
				return getResource();
		}
