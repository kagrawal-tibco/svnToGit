...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Value Label Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.cep.designtime.core.model.beviewsconfig.impl.ValueLabelStyleImpl#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link com.tibco.cep.designtime.core.model.beviewsconfig.impl.ValueLabelStyleImpl#getFontStyle <em>Font Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ValueLabelStyleImpl extends BEViewsElementImpl implements ValueLabelStyle {
	/**
	...
	protected EClass eStaticClass() {
		return BEViewsConfigurationPackage.eINSTANCE.getValueLabelStyle();
	}
	...
	public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_SIZE, oldFontSize, fontSize, !oldFontSizeESet));
	}
	...
	public void unsetFontSize() {
		...
		fontSizeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_SIZE, oldFontSize, FONT_SIZE_EDEFAULT, oldFontSizeESet));
	}
	...
	public void setFontStyle(FontStyleEnum newFontStyle) {
		...
		fontStyleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_STYLE, oldFontStyle, fontStyle, !oldFontStyleESet));
	}
	...
	public void unsetFontStyle() {
		...
		fontStyleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_STYLE, oldFontStyle, FONT_STYLE_EDEFAULT, oldFontStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_SIZE:
				return getFontSize();
			case BEViewsConfigurationPackage.VALUE_LABEL_STYLE__FONT_STYLE:
				return getFontStyle();
		}
