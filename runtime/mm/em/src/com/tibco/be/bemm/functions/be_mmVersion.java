/*
 * $HeadURL: https://svn.tibco.com/svn/be/trunk/be-main/runtime/mm/em/src/com/tibco/be/bemm/functions/be_mmVersion.tag $ $Revision: 48199 $ $Date: 2012-02-16 22:27:01 -0500 (Thu, 16 Feb 2012) $
 *
 * Copyright(c) 2007-2012 TIBCO Software Inc. All rights reserved.
 *
 * be-mm.jar Version Information
 *
 */
 ...
 * "be_mmVersion.java" is automatically generated at
 * build time from "be_mmVersion.tag"
 *
 * Any maintenance changes MUST be applied to "be_mmVersion.tag"
 ...
 * "be_mmVersion.tag" *AND* "be_mmVersion.java"
 *
 */

package com.tibco.be.bemm.functions;

public final class be_mmVersion {
