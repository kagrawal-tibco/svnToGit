 ...
 *
 * be-admin.jar Version Information
 *
 */
 ...
 * "be_adminVersion.java" is automatically generated at
 * build time from "be_adminVersion.tag"
 *
 * Any maintenance changes MUST be applied to "be_adminVersion.tag"
 * and an official build triggered to propagate such changes to
 * "be_adminVersion.java"
 *
 ...
 * "be_adminVersion.tag" *AND* "be_adminVersion.java"
 *
 */

package com.tibco.be.deployment.administrator;

public final class be_adminVersion {
