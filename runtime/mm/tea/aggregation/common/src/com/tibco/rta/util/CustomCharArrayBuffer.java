 ...
 */
public class CustomCharArrayBuffer implements Serializable {
    ...
    /**
     * Creates an instance of {@link com.tibco.rta.util.CustomCharArrayBuffer} with the given initial
     * capacity.
     *
     * @param capacity the capacity
     */
    public CustomCharArrayBuffer(int capacity) {
        super();
        if (capacity < 0) {
     ...
     *                                   <code>off</code> + <code>len</code> is out of range.
     */
    public void append(final CustomCharArrayBuffer b, int off, int len) {
        if (b == null) {
            return;
        }
     ...
     * @param b the source buffer to be appended.
     */
    public void append(final CustomCharArrayBuffer b) {
        if (b == null) {
            return;
        }
     ...
     *                                   <code>off</code> + <code>len</code> is out of range.
     */
    public void append(final CustomByteArrayBuffer b, int off, int len) {
        if (b == null) {
            return;
        }
        append(b.buffer(), off, len);
