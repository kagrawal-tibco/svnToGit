...
import static com.tibco.rta.service.persistence.memory.InMemoryConstant.DIMENSION_LEVEL_NO;
...
public class TableGenerationUtility {
	...
	public static void createTables(RtaSchema schema) throws DuplicateTableException, DuplicateColumnException, NoSuchTableException {
		...
		for (Cube cube : schema.getCubes()) {
			for (DimensionHierarchy dh : cube.getDimensionHierarchies()) {
				...
				indexes.add(DescriptorFactory.createColumnDescriptor(DIMENSION_LEVEL_NO, DataType.INTEGER, true));
