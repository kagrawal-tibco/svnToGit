 ...
 *
 */
public class BEApplicationCreateException extends Exception {
	 ...
	 * Default constructor
	 */
	public BEApplicationCreateException() {
	}
	 ...
	 */
	public BEApplicationCreateException(String message) {
		super(message);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationCreateException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationCreateException(String message, Throwable cause) {
		super(message, cause);
	}
}
