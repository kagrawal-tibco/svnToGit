 ...
 *
 */
public class BEApplicationLoadException extends Exception {
	 ...
	 * Default constructor
	 */
	public BEApplicationLoadException() {
	}
	 ...
	 */
	public BEApplicationLoadException(String message) {
		super(message);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationLoadException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationLoadException(String message, Throwable cause) {
		super(message, cause);
	}
}
