 ...
 *
 */
public class BEApplicationNotFoundException extends Exception {
	 ...
	 * Default constructor
	 */
	public BEApplicationNotFoundException() {
	}
	 ...
	 */
	public BEApplicationNotFoundException(String message) {
		super(message);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationNotFoundException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationNotFoundException(String message, Throwable cause) {
		super(message, cause);
	}
}
