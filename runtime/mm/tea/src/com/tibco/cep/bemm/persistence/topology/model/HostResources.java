 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.tibco.com/businessevents/BEMM/2009/09/BEMMTopology.xsd}host-resource" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "host-resources")
public class HostResources {

    @XmlElement(name = "host-resource", required = true)
    protected List<HostResource> hostResource;
    ...
    public List<HostResource> getHostResource() {
        if (hostResource == null) {
            hostResource = new ArrayList<HostResource>();
        }
