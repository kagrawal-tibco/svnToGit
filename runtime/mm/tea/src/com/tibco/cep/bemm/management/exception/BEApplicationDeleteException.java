...
/**
 * Exception is thrown when deleteing application failed.
 * 
 * @author dijadhav
 *
 */
public class BEApplicationDeleteException extends Exception {
	 ...
	 * Default constructor
	 */
	public BEApplicationDeleteException() {
	}
	 ...
	 */
	public BEApplicationDeleteException(String message) {
		super(message);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationDeleteException(Throwable cause) {
		super(cause);
	}
	 ...
	 *            - Cause of Exception.
	 */
	public BEApplicationDeleteException(String message, Throwable cause) {
		super(message, cause);
	}
}
