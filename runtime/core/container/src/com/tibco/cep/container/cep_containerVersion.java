 ...
 *
 * cep-container.jar Version Information
 *
 */
 ...
 * "cep_containerVersion.java" is automatically generated at
 * build time from "cep_containerVersion.tag"
 *
 * Any maintenance changes MUST be applied to "cep_containerVersion.tag"
 * and an official build triggered to propagate such changes to
 * "cep_containerVersion.java"
 *
 ...
 * "cep_containerVersion.tag" *AND* "cep_containerVersion.java"
 *
 */

package com.tibco.cep.container;

public final class cep_containerVersion {
