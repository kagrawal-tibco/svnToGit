 ...
 *
 * cep-kernel.jar Version Information
 *
 */
 ...
 * "cep_kernelVersion.java" is automatically generated at
 * build time from "cep_kernelVersion.tag"
 *
 * Any maintenance changes MUST be applied to "cep_kernelVersion.tag"
 * and an official build triggered to propagate such changes to
 * "cep_kernelVersion.java"
 *
 ...
 * "cep_kernelVersion.tag" *AND* "cep_kernelVersion.java"
 *
 */

package com.tibco.cep.kernel;

public final class cep_kernelVersion {
