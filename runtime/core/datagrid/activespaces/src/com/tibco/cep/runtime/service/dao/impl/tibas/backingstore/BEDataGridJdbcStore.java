 ...
 */
public class BEDataGridJdbcStore extends JdbcStore implements Persister {

    private final static Logger logger = LogManagerFactory.getLogManager().getLogger("backingstore.BEDataGridJdbcStore");
    ...
    public BEDataGridJdbcStore() {
        super();
        logger.log(Level.INFO, "Constructing generic ActiveSpaces JdbcStore");
    }

    public BEDataGridJdbcStore(String cacheName, Integer readOnly, ASControlDao controlDao) {
    ...
    public BEDataGridJdbcStore(String cacheName, String schedulerCacheName, Integer readOnly, ASControlDao controlDao) {
    ...
    public BEDataGridJdbcStore(String cacheName, Integer readOnly, String className, ASEntityDao entityDao) {
