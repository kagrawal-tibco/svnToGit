 ...
 */
public class ResumeAgents extends CacheServiceAgent {
    ...
    public final static boolean resumeAgents() throws Exception {
        ...
        if (cluster != null) {
            ...
            Map resultSet = invoker.query(new ResumeAgents(), null);
            ...
            while (iter.hasNext()) {
                ...
                if (ret instanceof Exception) {
                    if (canLogInfo) {
                        logger.log(Level.INFO, "%s: OnResume: Member=%s has an exception: %s",
