 ...
 */
public class PersistentEventExtHandle extends AbstractEventHandle implements ExtIdHandle, PropertyBasedStore.PropertyBasedStoreHandle, PersistentHandle, ObjectStore.ObjectStoreHandle {
    private long id;
    private String extId;
    private Event ref;
    private EventContext ctx;
    private ExtIdHandle nextExtIdEntry;
    
    public PersistentEventExtHandle(Event _event, AbstractEventHandle _next, TypeInfo _typeInfo) {
    ...
    public String printInfo() {
        if(ref == null) {
            ...
            return "object:" + refTypeName + "@" + id + "@" + extId + "(virtual), status:" + Integer.toBinaryString(status);
        } else
