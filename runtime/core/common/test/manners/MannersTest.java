...
public class MannersTest {
    ...
    MannersTest(String mannersFile, String repoUrl, String traFile) throws Exception {
    ...
    public static void main(String[] args) {
        try {
            ...
            String mannFile = args[2];

            System.out.println(">>> Running test for " + mannFile + " <<<");
            MannersTest test = new MannersTest(mannFile, repourl, traFile);
            test.readData();
