...
* XPath 2.0 function
*/
public class GetSecondsFromTimeFunc implements Function {

    public static final Function FUNCTION = new GetSecondsFromTimeFunc();
    public static final QName FUNCTION_NAME = new QName("get-seconds-from-time");

    private GetSecondsFromTimeFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(time.getSeconds());
