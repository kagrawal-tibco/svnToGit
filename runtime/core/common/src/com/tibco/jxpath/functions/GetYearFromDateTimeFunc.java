...
* XPath 2.0 function
*/
public class GetYearFromDateTimeFunc implements Function {

    public static final Function FUNCTION = new GetYearFromDateTimeFunc();
    public static final QName FUNCTION_NAME = new QName("get-year-from-dateTime");

    private GetYearFromDateTimeFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(dateTime.getYear());
