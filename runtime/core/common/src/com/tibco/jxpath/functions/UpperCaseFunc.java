...
*/
public class UpperCaseFunc implements Function {

    public static final Function FUNCTION = new UpperCaseFunc();
    public static final QName FUNCTION_NAME = new QName("upper-case");

    private UpperCaseFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        return new XString(s0.toUpperCase());
    }
}
