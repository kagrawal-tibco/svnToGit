...
* XPath 2.0 function
*/
public class GetTimezoneFromDateFunc implements Function {

    public static final Function FUNCTION = new GetTimezoneFromDateFunc();
    public static final QName FUNCTION_NAME = new QName("get-timezone-from-date");

    private GetTimezoneFromDateFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XString(date.getTimeZone().getDisplayName());
