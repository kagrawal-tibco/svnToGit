...
*/
public class LeftFunc implements Function {

    public static final Function FUNCTION = new LeftFunc();
    public static final QName FUNCTION_NAME = new QName("left");
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        return new XString(s0.substring(0, numChars));
    }
}
