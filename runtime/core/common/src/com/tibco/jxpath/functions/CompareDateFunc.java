...
* XPath 2.0 function
*/
public class CompareDateFunc implements Function {

    public static final Function FUNCTION = new CompareDateFunc();
    public static final QName FUNCTION_NAME = new QName("compare-date");

    private CompareDateFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        String dateString1 = args.get(0).str();
        String dateString2 = args.get(1).str();
        
        try {
        	XDate date1 = XDate.compile(dateString1);
        	XDate date2 = XDate.compile(dateString2);
