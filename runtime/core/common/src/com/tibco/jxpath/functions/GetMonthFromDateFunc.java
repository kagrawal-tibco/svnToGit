...
* XPath 2.0 function
*/
public class GetMonthFromDateFunc implements Function {

    public static final Function FUNCTION = new GetMonthFromDateFunc();
    public static final QName FUNCTION_NAME = new QName("get-month-from-date");

    private GetMonthFromDateFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(date.getMonth());
