...
*/
public class TrimFunc implements Function {

    public static final Function FUNCTION = new TrimFunc();
    public static final QName FUNCTION_NAME = new QName("trim");
