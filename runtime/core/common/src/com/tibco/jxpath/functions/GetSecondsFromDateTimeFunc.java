...
* XPath 2.0 function
*/
public class GetSecondsFromDateTimeFunc implements Function {

    public static final Function FUNCTION = new GetSecondsFromDateTimeFunc();
    public static final QName FUNCTION_NAME = new QName("get-seconds-from-dateTime");

    private GetSecondsFromDateTimeFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(dateTime.getSeconds());
