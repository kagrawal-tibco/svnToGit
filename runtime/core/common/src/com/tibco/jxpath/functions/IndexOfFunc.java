...
*/
public class IndexOfFunc implements Function {

    public static final Function FUNCTION = new IndexOfFunc();
    public static final QName FUNCTION_NAME = new QName("index-of");
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        return new XNumber(s0.indexOf(s1));
    }
}
