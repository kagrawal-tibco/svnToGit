...
* Author: Ryan Hollom
*/
public class TokenizeFunc implements Function {

    public static final Function FUNCTION = new TokenizeFunc();
    public static final QName FUNCTION_NAME = new QName("tokenize");

    private TokenizeFunc() { }
