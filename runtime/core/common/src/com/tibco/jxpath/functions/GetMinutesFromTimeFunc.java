...
* XPath 2.0 function
*/
public class GetMinutesFromTimeFunc implements Function {

    public static final Function FUNCTION = new GetMinutesFromTimeFunc();
    public static final QName FUNCTION_NAME = new QName("get-minutes-from-time");

    private GetMinutesFromTimeFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(time.getMinutes());
