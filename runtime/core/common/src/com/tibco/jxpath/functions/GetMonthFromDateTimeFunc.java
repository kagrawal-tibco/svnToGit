...
* XPath 2.0 function
*/
public class GetMonthFromDateTimeFunc implements Function {

    public static final Function FUNCTION = new GetMonthFromDateTimeFunc();
    public static final QName FUNCTION_NAME = new QName("get-month-from-dateTime");

    private GetMonthFromDateTimeFunc() { }
    ...
    public XObject execute(XPathContext context, List<XObject> args) throws XPathFunctionException {
        ...
        try {
			...
			return new XNumber(dateTime.getMonth());
