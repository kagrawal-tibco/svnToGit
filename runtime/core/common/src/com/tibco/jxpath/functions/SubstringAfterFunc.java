...
*/
public class SubstringAfterFunc implements Function {

    public static final Function FUNCTION = new SubstringAfterFunc();
    public static final QName FUNCTION_NAME = new QName("substring-after");

    private SubstringAfterFunc() { }
