...
*/
public class CeilingFunc implements Function {

    public static final Function FUNCTION = new CeilingFunc();
    public static final QName    FUNCTION_NAME = new QName("ceiling");
