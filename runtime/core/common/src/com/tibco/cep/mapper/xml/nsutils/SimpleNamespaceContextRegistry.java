 ...
 */
public class SimpleNamespaceContextRegistry implements NamespaceContextRegistry {
    ...
    public SimpleNamespaceContextRegistry()
    {
        this("ns");
    }

    public SimpleNamespaceContextRegistry(String prefixBase)
    {
        this(new DefaultNamespacePrefixRecommender(prefixBase,true));
    }

    public SimpleNamespaceContextRegistry(NamespacePrefixRecommender namespacePrefixRecommender)
    {
...
/*        if (mAutoRegister) {
    ...
    {
        SimpleNamespaceContextRegistry sni = new SimpleNamespaceContextRegistry(m_namespacePrefixRecommender);
