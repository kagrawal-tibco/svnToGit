 ...
 */
public class PropertyAtomIntImplBigIndex extends PropertyAtomIntImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomIntImplBigIndex(int historySize, Object owner) {
        super(historySize, owner);
    }

    public PropertyAtomIntImplBigIndex(int historySize, Object owner, int defaultValue) {
        super(historySize, owner, defaultValue);
    }

    @Override
    public PropertyAtomIntImplBigIndex copy(Object newOwner) {
        return _copy(new PropertyAtomIntImplBigIndex(0, newOwner));
    }

    protected PropertyAtomIntImplBigIndex _copy(PropertyAtomIntImplBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
