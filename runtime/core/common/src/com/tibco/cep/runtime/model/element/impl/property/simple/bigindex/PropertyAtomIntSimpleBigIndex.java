 ...
 */
public class PropertyAtomIntSimpleBigIndex extends PropertyAtomIntSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomIntSimpleBigIndex(Object owner) {
        super(owner);
    }

    public PropertyAtomIntSimpleBigIndex(Object owner, int defaultValue) {
    ...
    protected PropertyAtomIntSimpleBigIndex _copy(PropertyAtomIntSimpleBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
