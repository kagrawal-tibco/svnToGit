 ...
 */
public class PropertyAtomDoubleImplBigIndex extends PropertyAtomDoubleImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomDoubleImplBigIndex(int historySize, Object owner) {
        super(historySize, owner);
    }

    public PropertyAtomDoubleImplBigIndex(int historySize, Object owner, double defaultValue) {
        super(historySize, owner, defaultValue);
    }

    @Override
    public PropertyAtomDoubleImplBigIndex copy(Object newOwner) {
        return _copy(new PropertyAtomDoubleImplBigIndex(0, newOwner));
    }

    protected PropertyAtomDoubleImplBigIndex _copy(PropertyAtomDoubleImplBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
