 ...
 */
public class RemoteCacheConceptHandle extends CacheConceptHandle {
    String clusterName;

    public RemoteCacheConceptHandle(String clusterName, WorkingMemoryImpl wm, Element _concept) {
        super(wm,_concept);
