 ...
 */
public class CacheStateMachineConceptExHandle extends CacheConceptExHandle
{
    public CacheStateMachineConceptExHandle(WorkingMemoryImpl wm, Element _concept, boolean forceSet) {
