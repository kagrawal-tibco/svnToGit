 ...
 * 
 */
public class DefaultHotDeployer implements HotDeployer, ControlDao.ChangeListener<Integer, Object> {
    Cluster cluster;
     ...
     * @throws Exception
     */
    public DefaultHotDeployer() throws Exception {
    ...
    public void init (Cluster cluster) throws Exception {
        ...
        hotDeployer = cluster.getDaoProvider().createControlDao(Integer.class, Object.class, ControlDaoType.HotDeployer);
    ...
    public void onPut(Integer key, Object value) {
    ...
    public void onRemove(Integer key, Object value) {
    }
