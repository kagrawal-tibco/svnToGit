 ...
 */
public abstract class PropertyStateMachineCompositeStateBigIndex extends PropertyStateMachineCompositeState {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyStateMachineCompositeStateBigIndex(Object owner) {
        super(owner);
    }

    public PropertyStateMachineCompositeStateBigIndex(Object owner, int defaultValue) {
        super(owner, defaultValue);
    }

   protected PropertyStateMachineCompositeStateBigIndex _copy(PropertyStateMachineCompositeStateBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
