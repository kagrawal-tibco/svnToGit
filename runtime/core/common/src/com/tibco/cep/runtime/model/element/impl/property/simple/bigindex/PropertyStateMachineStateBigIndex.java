 ...
 */
public abstract class PropertyStateMachineStateBigIndex extends PropertyStateMachineState {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyStateMachineStateBigIndex(Object owner) {
        super(owner);
    }

    public PropertyStateMachineStateBigIndex(Object owner, int defaultValue) {
