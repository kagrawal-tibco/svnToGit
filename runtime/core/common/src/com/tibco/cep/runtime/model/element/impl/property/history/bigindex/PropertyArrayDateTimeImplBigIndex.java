 ...
 */
public class PropertyArrayDateTimeImplBigIndex extends PropertyArrayDateTimeImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayDateTimeImplBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArrayImpl copy(Object owner) {
        PropertyArrayDateTimeImplBigIndex copy = (PropertyArrayDateTimeImplBigIndex)_copy(new PropertyArrayDateTimeImplBigIndex ((ConceptImpl)owner, 0));
