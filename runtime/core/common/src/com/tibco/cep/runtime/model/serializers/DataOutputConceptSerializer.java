 ...
 */
public class DataOutputConceptSerializer implements ConceptSerializer {
...
//    protected PofWriter pofWriter;
     ...
     * @param buf
     */
    public DataOutputConceptSerializer(DataOutput buf, int typeId) {
        this.buf=buf;
        this.typeId=typeId;
    }
     ...
     * @param entityClz
     */
    public DataOutputConceptSerializer(DataOutput buf, Class entityClz) {
        try {
            this.buf=buf;
...
//    public DataOutputConceptSerializer(PofWriter pofWriter) {
