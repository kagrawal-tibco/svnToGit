 ...
 */
public class PropertyAtomContainedConceptSimpleBigIndex extends PropertyAtomContainedConceptSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomContainedConceptSimpleBigIndex(Object owner) {
        super(owner);
    }

    public PropertyAtomContainedConceptSimpleBigIndex(Object owner, ContainedConcept defaultValue) {
    ...
    protected PropertyAtomContainedConceptSimpleBigIndex _copy(PropertyAtomContainedConceptSimpleBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
