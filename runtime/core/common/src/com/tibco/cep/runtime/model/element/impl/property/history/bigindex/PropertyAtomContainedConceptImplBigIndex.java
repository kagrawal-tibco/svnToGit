 ...
 */
public class PropertyAtomContainedConceptImplBigIndex extends PropertyAtomContainedConceptImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomContainedConceptImplBigIndex(int historySize, Object owner) {
        super(historySize, owner);
    }

    public PropertyAtomContainedConceptImplBigIndex(int historySize, Object owner, ContainedConcept defaultValue) {
        super(historySize, owner, defaultValue);
    }

    @Override
    public PropertyAtomContainedConceptImplBigIndex copy(Object newOwner) {
        return _copy(new PropertyAtomContainedConceptImplBigIndex(0, newOwner));
    }

     protected PropertyAtomContainedConceptImplBigIndex _copy(PropertyAtomContainedConceptImplBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
