 ...
 */
public class PropertyAtomBooleanImplBigIndex extends PropertyAtomBooleanImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomBooleanImplBigIndex(int historySize, Object owner) {
        super(historySize, owner);
    }

   public PropertyAtomBooleanImplBigIndex(int historySize, Object owner, boolean defaultValue) {
       super(historySize, owner, defaultValue);
    }

    @Override
    public PropertyAtomBooleanImplBigIndex copy(Object newOwner) {
        return _copy(new PropertyAtomBooleanImplBigIndex(0, newOwner));
    }

    protected PropertyAtomBooleanImplBigIndex _copy(PropertyAtomBooleanImplBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
