...
// +------------------------------------------------------------------------+ //
// |                                                                        | //
// |     THIS MUST CONFORM TO THE LAYOUT THAT ADMINISTRATOR UNDERSTANDS     | //
// |                                                                        | //
// +------------------------------------------------------------------------+ //
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Default trace message layout, which conforms to the standard TIBCO Administrator log format.
 *
 * @version 2.0
 * @since 2.0
 */
public class TraceMessageLayout extends Layout {
    ...
    public TraceMessageLayout(String name, String dateFormat) {
    ...
    public String format(LoggingEvent loggingEvent) {
        return this.getTimeStamp()
                ...
                + "] - [" + loggingEvent.getLogger().getName()
