 ...
 */
public abstract class PropertyStateMachineReferencedStateBigIndex extends PropertyStateMachineReferencedState {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyStateMachineReferencedStateBigIndex(Object owner) {
        super(owner);
    }

    public PropertyStateMachineReferencedStateBigIndex(Object owner, int defaultValue) {
        super(owner, defaultValue);
    }

    protected PropertyStateMachineReferencedStateBigIndex _copy(PropertyStateMachineReferencedStateBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
