 ...
 */
public class PropertyArrayStringImplBigIndex extends PropertyArrayStringImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayStringImplBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArrayImpl copy(Object owner) {
        PropertyArrayStringImplBigIndex copy = (PropertyArrayStringImplBigIndex)_copy(new PropertyArrayStringImplBigIndex ((ConceptImpl)owner, 0));
