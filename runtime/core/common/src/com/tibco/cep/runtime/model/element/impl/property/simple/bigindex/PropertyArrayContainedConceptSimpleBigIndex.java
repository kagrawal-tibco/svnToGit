 ...
 */
public class PropertyArrayContainedConceptSimpleBigIndex extends PropertyArrayContainedConceptSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayContainedConceptSimpleBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArraySimple copy(Object newOwner) {
        PropertyArrayContainedConceptSimpleBigIndex ret = (PropertyArrayContainedConceptSimpleBigIndex)_copy(new PropertyArrayContainedConceptSimpleBigIndex((ConceptImpl)newOwner, 0));;
        ret.id_14_7 = id_14_7;
