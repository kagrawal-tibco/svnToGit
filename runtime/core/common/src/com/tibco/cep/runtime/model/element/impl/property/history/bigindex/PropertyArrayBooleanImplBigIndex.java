 ...
 */
public class PropertyArrayBooleanImplBigIndex extends PropertyArrayBooleanImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayBooleanImplBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArrayImpl copy(Object owner) {
        PropertyArrayBooleanImplBigIndex copy = (PropertyArrayBooleanImplBigIndex)_copy(new PropertyArrayBooleanImplBigIndex((ConceptImpl)owner, 0));
