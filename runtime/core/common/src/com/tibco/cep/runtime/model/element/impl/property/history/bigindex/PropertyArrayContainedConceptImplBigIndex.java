 ...
 */
public class PropertyArrayContainedConceptImplBigIndex extends PropertyArrayContainedConceptImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayContainedConceptImplBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArrayImpl copy(Object owner) {
        PropertyArrayContainedConceptImplBigIndex copy = (PropertyArrayContainedConceptImplBigIndex)_copy(new PropertyArrayContainedConceptImplBigIndex((ConceptImpl)owner, 0));
