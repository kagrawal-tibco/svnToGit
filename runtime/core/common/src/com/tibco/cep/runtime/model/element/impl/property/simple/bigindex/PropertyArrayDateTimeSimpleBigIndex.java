 ...
 */
public class PropertyArrayDateTimeSimpleBigIndex extends PropertyArrayDateTimeSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayDateTimeSimpleBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArraySimple copy(Object newOwner) {
        PropertyArrayDateTimeSimpleBigIndex ret = (PropertyArrayDateTimeSimpleBigIndex)_copy(new PropertyArrayDateTimeSimpleBigIndex((ConceptImpl)newOwner, 0));;
        ret.id_14_7 = id_14_7;
