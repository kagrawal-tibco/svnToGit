 ...
 */
public class PropertyAtomConceptReferenceSimpleBigIndex extends PropertyAtomConceptReferenceSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomConceptReferenceSimpleBigIndex(Object owner) {
        super(owner);
    }

    public PropertyAtomConceptReferenceSimpleBigIndex(Object owner, Concept defaultValue) {
    ...
    protected PropertyAtomConceptReferenceSimpleBigIndex _copy(PropertyAtomConceptReferenceSimpleBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
