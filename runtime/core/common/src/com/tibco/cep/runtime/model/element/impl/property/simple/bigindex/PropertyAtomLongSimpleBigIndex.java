 ...
 */
public class PropertyAtomLongSimpleBigIndex extends PropertyAtomLongSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomLongSimpleBigIndex(Object owner) {
        super(owner);
    }

    public PropertyAtomLongSimpleBigIndex(Object owner, long defaultValue) {
    ...
    protected PropertyAtomLongSimpleBigIndex _copy(PropertyAtomLongSimpleBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
