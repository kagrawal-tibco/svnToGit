...
abstract public class PropertyArrayRaw extends AbstractPropertyArray {
    protected PropertyArrayRaw(ConceptImpl parent, int length) {
    	super(parent, length);
    }

    @Override
    final public PropertyArrayRaw copy(Object newOwner) {
    ...
    protected AbstractPropertyAtom newEmptyAtom(AbstractPropertyArray newOwner) {
    	return newEmptyAtom((PropertyArrayRaw)newOwner);
    }
    
	abstract protected PropertyAtomRaw newEmptyAtom(PropertyArrayRaw newOwner);
    ...
    @Override final protected void checkSession() {}
}
