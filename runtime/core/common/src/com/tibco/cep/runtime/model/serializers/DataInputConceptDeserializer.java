 ...
 */
public class DataInputConceptDeserializer implements ConceptDeserializer {
	protected boolean error=false;
	protected String msg;

    protected DataInput buf;
    protected int currentHistorySize;
    protected int currentHistoryIndex;
    protected long id;
    protected int version;
    protected String extId;
    protected boolean hasSchemaChanged=false;
    protected ConceptSerializer.ConceptMigrator migrator;
     ...
     * @param buf
     */
    public DataInputConceptDeserializer(DataInput buf) throws IOException{
        this.buf=buf;
        //keep this header in sync with extractVersion
        typeId=buf.readInt();
        version=buf.readInt();
    ...
    //keep in sync with above code
    public static int extractVersion(DataInput buf) throws IOException {
        //typeId
    	buf.readInt();
        return buf.readInt();
    }
...
//    public DataInputConceptDeserializer(PofReader pofReader) throws IOException{
...
//        version=buf.readInt();
//    }
    public DataInputConceptDeserializer(DataInput buf, ConceptSerializer.ConceptMigrator migrator) throws IOException{
        this(buf);
