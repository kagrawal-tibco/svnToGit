 ...
 */
public class PropertyArrayDoubleImplBigIndex extends PropertyArrayDoubleImpl {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyArrayDoubleImplBigIndex(ConceptImpl parent, int initialSize) {
        super(parent, initialSize);
    }

    @Override
    public PropertyArrayImpl copy(Object owner) {
        PropertyArrayDoubleImplBigIndex copy = (PropertyArrayDoubleImplBigIndex)_copy(new PropertyArrayDoubleImplBigIndex ((ConceptImpl)owner, 0));
