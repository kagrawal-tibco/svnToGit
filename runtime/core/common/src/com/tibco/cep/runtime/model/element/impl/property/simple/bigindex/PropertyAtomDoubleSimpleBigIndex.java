 ...
 */
public class PropertyAtomDoubleSimpleBigIndex extends PropertyAtomDoubleSimple {
    //this plus the status byte adds up to 32 bits so the object won't waste space with padding
    byte id_14_7;
    short id_30_15;

    public PropertyAtomDoubleSimpleBigIndex(Object owner) {
        super(owner);
    }

    public PropertyAtomDoubleSimpleBigIndex(Object owner, double defaultValue) {
    ...
    protected PropertyAtomDoubleSimpleBigIndex _copy(PropertyAtomDoubleSimpleBigIndex ret) {
        super._copy(ret);
        ret.id_14_7 = id_14_7;
