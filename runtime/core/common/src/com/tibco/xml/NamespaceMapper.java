 ...
 */
public interface NamespaceMapper extends NamespaceImporter
{
    /**
    ...
    public String getNamespaceURIForPrefix(String namespacePrefix) throws PrefixToNamespaceResolver.PrefixNotFoundException;
