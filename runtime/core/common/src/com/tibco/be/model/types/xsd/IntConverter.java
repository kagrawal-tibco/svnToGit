 ...
 */
public class IntConverter extends XSDBuiltInConverter{
    //-------------------------------------------------------------------------
    // constructor
    //-------------------------------------------------------------------------
    public IntConverter(Class xsdClass,
                         Class javaClass) {
    ...
    public static void register(TypeConverterHandler handler) {
       TypeConverter tc = new IntConverter(DEFAULT_TYPE, JAVA_CLASS);
    ...
    public static final Class DEFAULT_TYPE = XsInt.class;
}
