...
public @interface BEConstant {
	 ...
	 */
    BEMapper mapper() default @BEMapper();
     ...
     */
    FunctionDomain[] fndomain() default { FunctionDomain.ACTION, FunctionDomain.BUI, FunctionDomain.CONDITION, FunctionDomain.PROCESS};
