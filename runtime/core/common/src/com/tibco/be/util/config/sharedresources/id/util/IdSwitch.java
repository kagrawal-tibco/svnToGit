...
public class IdSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case IdPackage.ID_ROOT: {
				IdRoot idRoot = (IdRoot)theEObject;
				T result = caseIdRoot(idRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IdPackage.NODE: {
			...
			case IdPackage.RESOURCE_DESCRIPTIONS: {
				ResourceDescriptions resourceDescriptions = (ResourceDescriptions)theEObject;
				T result = caseResourceDescriptions(resourceDescriptions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseIdRoot(IdRoot object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Resource Descriptions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Resource Descriptions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseResourceDescriptions(ResourceDescriptions object) {
		return null;
	}
