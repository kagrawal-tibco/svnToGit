 ...
 *
 * cep-docker.jar Version Information
 *
 */
 ...
 * "cep_dockerVersion.java" is automatically generated at
 * build time from "cep_dockerVersion.tag"
 *
 * Any maintenance changes MUST be applied to "cep_dockerVersion.tag"
 * and an official build triggered to propagate such changes to
 * "cep_dockerVersion.java"
 *
 ...
 * "cep_dockerVersion.tag" *AND* "cep_dockerVersion.java"
 *
 */

package com.tibco.be.util.docker.version;

public final class cep_dockerVersion {
