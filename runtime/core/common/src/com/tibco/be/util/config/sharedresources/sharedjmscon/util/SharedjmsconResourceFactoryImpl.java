 ...
 * <!-- end-user-doc -->
 * @see com.tibco.be.util.config.sharedresources.sharedjmscon.util.SharedjmsconResourceImpl
 * @generated
 */
public class SharedjmsconResourceFactoryImpl extends ResourceFactoryImpl {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public SharedjmsconResourceFactoryImpl() {
		super();
	...
	public Resource createResource(URI uri) {
		XMLResource result = new SharedjmsconResourceImpl(uri);
...
} //SharedjmsconResourceFactoryImpl
