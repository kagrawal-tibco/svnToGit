 ...
 * <!-- end-user-doc -->
 * @see com.tibco.be.util.config.sharedresources.sharedjmscon.SharedjmsconPackage#getResourceType()
 * @model extendedMetaData="name='resourceType_._type'"
 * @generated
 */
public enum ResourceType implements Enumerator {
	/**
	 * The '<em><b>Ae Shared JMS Connection Key</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #AE_SHARED_JMS_CONNECTION_KEY_VALUE
	 * @generated
	 * @ordered
	 */
	AE_SHARED_JMS_CONNECTION_KEY(0, "aeSharedJMSConnectionKey", "ae.shared.JMSConnectionKey");

	/**
	 * The '<em><b>Ae Shared JMS Connection Key</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Ae Shared JMS Connection Key</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #AE_SHARED_JMS_CONNECTION_KEY
	 * @model name="aeSharedJMSConnectionKey" literal="ae.shared.JMSConnectionKey"
	 * @generated
	 * @ordered
	 */
	public static final int AE_SHARED_JMS_CONNECTION_KEY_VALUE = 0;
	...
	public static ResourceType get(int value) {
		switch (value) {
			case AE_SHARED_JMS_CONNECTION_KEY_VALUE: return AE_SHARED_JMS_CONNECTION_KEY;
		}
		return null;
	}
