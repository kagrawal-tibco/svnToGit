 ...
 * <ul>
 *   <li>{@link com.tibco.be.util.config.sharedresources.sharedjmscon.impl.JndiPropertiesImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.tibco.be.util.config.sharedresources.sharedjmscon.impl.JndiPropertiesImpl#getRow <em>Row</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class JndiPropertiesImpl extends EObjectImpl implements JndiProperties {
	...
	protected EClass eStaticClass() {
		return SharedjmsconPackage.Literals.JNDI_PROPERTIES;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, SharedjmsconPackage.JNDI_PROPERTIES__GROUP);
		}
		return group;
	}
	...
	public EList<Row> getRow() {
		return getGroup().list(SharedjmsconPackage.Literals.JNDI_PROPERTIES__ROW);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SharedjmsconPackage.JNDI_PROPERTIES__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case SharedjmsconPackage.JNDI_PROPERTIES__ROW:
