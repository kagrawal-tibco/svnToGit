 ...
 */
public class OracleConceptDeserializer_NoNullProps implements ConceptDeserializer {
    boolean error=false;
    String msg;
     ...
     * @param buf
     */
    public OracleConceptDeserializer_NoNullProps(OracleConceptMap entityDescription, OracleConnection oracle, Datum[] attributes) {
    ...
    public void endProperty() {
        ...
        historyTimeCursor=0;historyValueCursor=0;
        inArray=false;
    ...
    public ConceptOrReference getContainedConceptProperty() {
        try {
            ...
            if (ret != null) {
                Datum[] attributes= ret.getOracleAttributes();
                if ((attributes != null) && (attributes[0] != null)) {
                    long id=((oracle.sql.NUMBER)attributes[0]).longValue();
                    return new com.tibco.cep.runtime.model.element.impl.Reference(id);
                } else {
                    return null;
                }
            } else {
