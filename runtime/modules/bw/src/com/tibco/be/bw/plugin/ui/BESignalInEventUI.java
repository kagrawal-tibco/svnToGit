...
public class BESignalInEventUI extends BasicEventSourceResource implements FieldChangeListener {


    public static final String TYPE = "ae.activities.BESignalInEvent";
    ...
    public BESignalInEventUI() {
        super();
        uiHelper = new BEPluginUIHelper();
    }


    public BESignalInEventUI(boolean b) {
        super(b);
        uiHelper = new BEPluginUIHelper();
    }
    ...
    public void fieldChanged(FieldChangeEvent event) {
        try {
            ...
            } else if (event.getPropertyName().equals(BEPluginConstants.OUTPUT_STYLE.getLocalName())) {
