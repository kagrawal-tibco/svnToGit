...
public class BESendEventUI extends BWActivityResource implements FieldChangeListener{

    public static final String TYPE = "ae.activities.BESendEvent";
    ...
    public BESendEventUI() {
        super();
        uiHelper = new BEPluginUIHelper();
    }


    public BESendEventUI(boolean b) {
        super(b);
        uiHelper = new BEPluginUIHelper();
    }
    ...
    public void buildConfigurationForm(ConfigForm form, DesignerDocument doc) {
        ...
        form.addField(uiHelper.newEncodingsList(this));
