 ...
 * Time: 3:13 PM
 */
public class RuleTemplateDeploymentTransactionPrepare
        extends RuleTemplateDeploymentInvocable {


    public RuleTemplateDeploymentTransactionPrepare(
            long transactionId)
            throws Exception {
    ...
    public Object invoke(
        ...
        if (null == transaction) {
            throw new IllegalStateException("Cannot prepare transaction that does not exist: " + id);
        }
