 ...
 * Time: 3:13 PM
 */
public class RuleTemplateDeploymentTransactionCommit
        extends RuleTemplateDeploymentInvocable {


    public RuleTemplateDeploymentTransactionCommit(
            long transactionId)
            throws Exception {
    ...
    public Object invoke(
        ...
        if (null == transaction) {
            throw new IllegalStateException("Cannot commit transaction that does not exist: " + id);
        }
