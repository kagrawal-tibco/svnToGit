...
* Time: 4:08:45 PM
*/
public class LongArrayItemEvaluator
        extends ArrayItemEvaluator {


    public LongArrayItemEvaluator(ExpressionEvaluator arrayEvaluator, ExpressionEvaluator indexEvaluator) {
    ...
    public long evaluateLong(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        final long[] array = (long[]) this.arrayEvaluator.evaluate(globalContext, queryContext, aliasAndTuples);
