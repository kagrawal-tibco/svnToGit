...
* Time: 4:08:45 PM
*/
public class ObjectArrayItemEvaluator
        extends ArrayItemEvaluator {


    public ObjectArrayItemEvaluator(ExpressionEvaluator arrayEvaluator, ExpressionEvaluator indexEvaluator) {
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        final Object[] array = (Object[]) this.arrayEvaluator.evaluate(globalContext, queryContext, aliasAndTuples);
