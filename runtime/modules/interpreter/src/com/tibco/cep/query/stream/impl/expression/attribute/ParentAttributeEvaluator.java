...
* Time: 4:50:13 PM
*/
public class ParentAttributeEvaluator
     ...
     */
    public ParentAttributeEvaluator(ExpressionEvaluator containerEvaluator) {
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        ...
        return ((ContainedConcept) container).getParent();
    }
