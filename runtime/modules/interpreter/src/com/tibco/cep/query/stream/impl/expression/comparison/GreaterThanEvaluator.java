...
public class GreaterThanEvaluator
    ...
    public GreaterThanEvaluator(ExpressionEvaluator leftEvaluator, ExpressionEvaluator rightEvaluator) {
    ...
    public boolean evaluateBoolean(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        ...
        if (left instanceof Calendar) {
            return Comparisons.greaterThan((Calendar) left, right);
        } else if (left instanceof Number) {
            return Comparisons.greaterThan((Number) left, right);
        } else if (left instanceof String) {
            return Comparisons.greaterThan((String) left, right);
        } else if (right instanceof Calendar) {
            return Comparisons.greaterThan((Calendar) right, left);
        } else if (right instanceof Number) {
            return Comparisons.greaterThan((Number) right, left);
        } else if (right instanceof String) {
            return Comparisons.greaterThan((String) right, left);
        } else {
