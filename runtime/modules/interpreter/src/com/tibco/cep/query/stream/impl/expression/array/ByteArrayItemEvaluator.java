...
* Time: 4:08:45 PM
*/
public class ByteArrayItemEvaluator
        extends ArrayItemEvaluator {


    public ByteArrayItemEvaluator(ExpressionEvaluator arrayEvaluator, ExpressionEvaluator indexEvaluator) {
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        final byte[] array = (byte[]) this.arrayEvaluator.evaluate(globalContext, queryContext, aliasAndTuples);
