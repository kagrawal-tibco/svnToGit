...
* Time: 4:08:45 PM
*/
public class IntArrayItemEvaluator
        extends ArrayItemEvaluator {


    public IntArrayItemEvaluator(ExpressionEvaluator arrayEvaluator, ExpressionEvaluator indexEvaluator) {
    ...
    public int evaluateInteger(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        final int[] array = (int[]) this.arrayEvaluator.evaluate(globalContext, queryContext, aliasAndTuples);
