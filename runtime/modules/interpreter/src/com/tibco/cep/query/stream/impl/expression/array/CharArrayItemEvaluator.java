...
* Time: 4:08:45 PM
*/
public class CharArrayItemEvaluator
        extends ArrayItemEvaluator {


    public CharArrayItemEvaluator(ExpressionEvaluator arrayEvaluator, ExpressionEvaluator indexEvaluator) {
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        final char[] array = (char[]) this.arrayEvaluator.evaluate(globalContext, queryContext, aliasAndTuples);
