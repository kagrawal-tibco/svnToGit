...
* Time: 5:47:59 PM
*/
public class ConceptPropertyAtomEvaluator extends PropertyEvaluator {
     ...
     */
    public ConceptPropertyAtomEvaluator(ExpressionEvaluator containerEvaluator, String propertyName) {
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        ...
        return ((Concept) container).getPropertyAtom(this.propertyName);
    }
