...
* Time: 6:44:17 PM
*/
public class ObjectToBooleanEvaluator
    ...
    public ObjectToBooleanEvaluator(
    ...
    public Object evaluate(GlobalContext globalContext, QueryContext queryContext, FixedKeyHashMap<String, ? extends Tuple> aliasAndTuples) {
        return TypeHelper.toBoolean(this.objectEvaluator.evaluate(globalContext, queryContext, aliasAndTuples));
    }
