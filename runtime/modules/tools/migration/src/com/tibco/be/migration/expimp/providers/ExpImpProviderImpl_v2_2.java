...
import com.tibco.be.migration.expimp.providers.bdb.BDBExporter_v2_2;
import com.tibco.be.migration.expimp.providers.bdb.BdbImporter_v2_2;
import com.tibco.be.migration.expimp.providers.cache.CacheExporter_v2_2;
import com.tibco.be.migration.expimp.providers.db.OracleImporter_v2_2;
 ...
 */
public class ExpImpProviderImpl_v2_2 implements ExpImpProvider {
    ...
    public void doExport(ExpImpContext context, ExpImpStats stats) throws Exception {
        switch(context.getMethod()) {
             case BEMigrationProperties.IMPEXP_METHOD_BDB: {
                BDBExporter_v2_2 exporter = new BDBExporter_v2_2();
            ...
            case BEMigrationProperties.IMPEXP_METHOD_DB: {
                CacheExporter_v2_2 exporter = new CacheExporter_v2_2();
                exporter.init(context, stats);
                exporter.exportAll();
                exporter.destroy();
            }
    ...
    public void doImport(ExpImpContext context, ExpImpStats stats) throws Exception {
        switch(context.getMethod()) {
            case BEMigrationProperties.IMPEXP_METHOD_BDB: {
                ...
                break;
            case BEMigrationProperties.IMPEXP_METHOD_DB: {
                OracleImporter_v2_2 importer = new OracleImporter_v2_2();
                importer.init(context, stats);
                importer.importAll();
                importer.destroy();
            }
