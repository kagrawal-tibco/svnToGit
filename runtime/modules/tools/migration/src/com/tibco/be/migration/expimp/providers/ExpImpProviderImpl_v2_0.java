...
import com.tibco.be.migration.expimp.providers.bdb.BdbImporter_v2_0;
import com.tibco.be.migration.expimp.providers.cache.CacheExporter_v2_0;
import com.tibco.be.migration.expimp.providers.db.OracleImporter_v2_0;
 ...
 */
public class ExpImpProviderImpl_v2_0 implements ExpImpProvider {
    ...
    public void doExport(ExpImpContext context, ExpImpStats stats) throws Exception {
         ...
         switch(context.getMethod()) {
             case BEMigrationProperties.IMPEXP_METHOD_BDB: {
                 BDBExporter_v2_0 exporter = new BDBExporter_v2_0();
            ...
            case BEMigrationProperties.IMPEXP_METHOD_DB: {
                CacheExporter_v2_0 exporter = new CacheExporter_v2_0();
                exporter.init(context, stats);
                exporter.exportAll();
                exporter.destroy();
            }
    ...
    public void doImport(ExpImpContext context, ExpImpStats stats) throws Exception {
        switch(context.getMethod()) {
            case BEMigrationProperties.IMPEXP_METHOD_BDB: {
                BdbImporter_v2_0 importer = new BdbImporter_v2_0();
                ...
                break;
            case BEMigrationProperties.IMPEXP_METHOD_DB: {
                OracleImporter_v2_0 importer = new OracleImporter_v2_0();
                importer.init(context, stats);
                importer.importAll();
                importer.destroy();
            }
