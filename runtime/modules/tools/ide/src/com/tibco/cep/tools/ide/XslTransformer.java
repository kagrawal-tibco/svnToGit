...
public class XslTransformer {
    ...
    public XslTransformer(InputStream xslt) throws TransformerConfigurationException {
    ...
    public static void transform(InputStream xml, InputStream xslt, OutputStream output, Map<String, Object> params)
...
//        System.out.println();
//
//        processFile(new XslTransformer(xslt), xmlFile, filter, outputExtension, new ConcurrentHashMap<String, String>());
//    }
//
//
//    protected static void processFile(
//            XslTransformer t, File f, FilenameFilter filter, String outputExtension,
