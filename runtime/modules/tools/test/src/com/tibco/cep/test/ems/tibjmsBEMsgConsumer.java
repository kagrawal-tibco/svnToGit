...
import com.tibco.cep.test.ems.tibjmsUtilities;

public class tibjmsBEMsgConsumer implements Runnable {
    // parameters
     ...
     */
    public tibjmsBEMsgConsumer(String[] args)
    {
        parseArgs(args);
    ...
    {
    	tibjmsBEMsgConsumer t = new tibjmsBEMsgConsumer(args);
    }
}
