...
public class tibjmsBEMsgProducer implements Runnable {
	// parameters
	 ...
	 */
	public tibjmsBEMsgProducer(String[] args)  {
		parseArgs(args);
		...
		try {
			...
			System.err.println();
			System.err.println("------------------------------------------------------------------------");
			System.err.println("TIBCO BusinessEvents EMS Message Producer Information");
			System.err.println("------------------------------------------------------------------------");
...
//									" and " + msg.getStringProperty("_nm_"));
	...
	private void usage()
	{
		System.err.println("\nUsage: java tibjmsBEMsgProducer [options] [ssl options]");
		System.err.println("\n");
	...
	{
		tibjmsBEMsgProducer t = new tibjmsBEMsgProducer(args);
	}
}
