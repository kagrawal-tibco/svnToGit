...
/*
 * Modified from original tibrvmultisend - sample Rendezvous multi-field message publisher
 *
 * Type is a string which represents one of the scalar rv datatypes
 ...
 * the field will be added as a string.
 *
 * Examples:
 *
...
public class tibrvBEMsgProducer
{
    ...
    public tibrvBEMsgProducer(String args[])
    {
