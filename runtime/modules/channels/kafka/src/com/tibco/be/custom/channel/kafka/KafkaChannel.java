...
public class KafkaChannel extends BaseChannel {
	...
	/**
	 * We have chosen to override init() It will initialize a common threadpool for all Kafka Destinations to use, to start their consumers
	 */
	@Override
	...
	/**
	 * We have chosen to override close() It will call the super close and additionally 
	 * perform kafkaChannel's close tasks.
	 */
	@Override
