 ...
 */
public class PrintRuleNetworkMethod implements Command {


    private HawkRuleAdministrator ruleAdmin;


    public PrintRuleNetworkMethod(HawkRuleAdministrator ruleAdministrator) {
    ...
    public NVPair[] invoke(RuleServiceProvider rsp, String inputParams) throws Exception {
        ...
        for (int i = 0; i < sessions.length; i++) {
            ...
            lines.add(new NVPair(session.getName(), ((ReteWM) session.getWorkingMemory()).printReteNetwork()));
        }//for
