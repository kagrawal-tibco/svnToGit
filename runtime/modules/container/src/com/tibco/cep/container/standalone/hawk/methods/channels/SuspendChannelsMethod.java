 ...
 */
public class SuspendChannelsMethod extends AmiMethod {


    protected HawkRuleAdministrator m_hma;


    public SuspendChannelsMethod(HawkRuleAdministrator hma) {
        super("suspendChannels", "Suspends channels.", AmiConstants.METHOD_TYPE_ACTION);
        m_hma = hma;
    }//constr
    ...
    public AmiParameterList getArguments() {
        ...
        args.addElement(new AmiParameter("URI", "URI of the Channel to suspend (optional).", ""));
        return args;
    }
