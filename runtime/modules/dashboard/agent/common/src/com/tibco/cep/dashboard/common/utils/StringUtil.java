...
public class StringUtil {
	...
	public static String join(List<Object> l, String sep) {
	...
	public static String fromSet(Set<?> s) {
		return fromCollection(s.iterator(), "", ",", "");
	}

	public static String fromSet(Set<?> s, String prefix, String sep, String suffix) {
	 ...
	 */
	public static String fromMap(Map<String, ?> m) {
		return fromMap(m, "", ";", "");
	}
	 ...
	 * @return
	 */
	public static String fromMap(Map<String, ?> m, String prefix, String sep, String suffix) {
		...
		while (iter.hasNext()) {
			...
			val = (val instanceof List) ? fromList((List<?>) val) : val.toString();
	...
	public static void main(String[] args) {
		...
		String[] result = null;
		result = StringUtil.split("getFieldArray:", ':');
		...
		System.out.println("ePulseMonitor_Data0@ABN works -- right?: " + StringUtil.makePrettyName("ePulseMonitor_Data0@ABN works -- right?"));
	}
}
