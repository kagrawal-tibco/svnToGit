...
public class StandAloneDashboardSession implements DashboardSession {

	private RuleServiceProvider ruleServiceProvider;

	public StandAloneDashboardSession(File configurationFile) throws ManagementException {
		super();
		try {
			ruleServiceProvider = new StandAloneRuleServiceProvider(configurationFile);
		} catch (IOException e) {
			throw new ManagementException("could not load " + configurationFile, e);
		}
	}
