...
public class TestIsNotCondition {
	...
	public void test() throws Exception {
		evaluator = new ASTWalker("$testName is not null");
		Map<String, Object> bindValues = new HashMap<String, Object>();
		bindValues.put("testName", "some value");
		Assert.assertEquals(evaluator.evaluate(concept, bindValues), true);
		evaluator = new ASTWalker("@extId is not null");
