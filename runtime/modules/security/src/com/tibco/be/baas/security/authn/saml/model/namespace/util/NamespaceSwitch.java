...
public class NamespaceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NamespacePackage.XML_NAMESPACE_DOCUMENT_ROOT: {
				XMLNamespaceDocumentRoot xmlNamespaceDocumentRoot = (XMLNamespaceDocumentRoot)theEObject;
				T result = caseXMLNamespaceDocumentRoot(xmlNamespaceDocumentRoot);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>XML Namespace Document Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XML Namespace Document Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXMLNamespaceDocumentRoot(XMLNamespaceDocumentRoot object) {
		return null;
	}
