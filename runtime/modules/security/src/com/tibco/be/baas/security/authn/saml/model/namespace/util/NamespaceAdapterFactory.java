...
public class NamespaceAdapterFactory extends AdapterFactoryImpl {
	...
	protected NamespaceSwitch<Adapter> modelSwitch =
		new NamespaceSwitch<Adapter>() {
			@Override
			public Adapter caseXMLNamespaceDocumentRoot(XMLNamespaceDocumentRoot object) {
				return createXMLNamespaceDocumentRootAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.tibco.be.baas.security.authn.saml.model.namespace.XMLNamespaceDocumentRoot <em>XML Namespace Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXMLNamespaceDocumentRootAdapter() {
		return null;
	}
