 ...
 * <ul>
 *   <li>{@link com.tibco.be.baas.security.authn.saml.model.protocol.impl.ExtensionsTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionsTypeImpl extends EObjectImpl implements ExtensionsType {
	...
	protected EClass eStaticClass() {
		return ProtocolPackage.Literals.EXTENSIONS_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, ProtocolPackage.EXTENSIONS_TYPE__ANY);
		}
		return any;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProtocolPackage.EXTENSIONS_TYPE__ANY:
