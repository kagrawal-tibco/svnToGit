 ...
 * 
 */
package com.tibco.cep.security.dataprovider;

import java.util.Iterator;
import java.util.Properties;

import com.tibco.cep.security.dataprovider.impl.DataProviderException;
...
public interface IUserDataProvider {
	...
	/**
	 * Takes the <b>username</b> and fetches the its notify Id.
	 * <p>
	 * Notify Id can be the user email id.
	 * </p>
	 * @param user
	 * @return Notify Id
	 * @throws DataProviderException if exception is thrown while fetching.
	 */
