...
/**
 * StreamDescriptor for a DistinctFilteredStream.
 */
public class DistinctFilteredStreamDescriptor extends StreamDescriptorImpl {
     ...
     */
    public DistinctFilteredStreamDescriptor(
            String streamName,
