package com.tibco.cep.query.benchmark.util;

import com.tibco.tibrv.*;

/*
* Author: Ashwin Jayaprakash Date: Jun 19, 2008 Time: 6:36:31 PM
*/
public class RVPayloadSender {
    String service = null;
    ...
    String FIELD_PAYLOAD = "_payload_";

    public RVPayloadSender(String args[]) {
        ...
        try {
            ...
            while (i < args.length) {
                System.out.println("Publishing: subject=" + msg.getSendSubject() +
                        " \"" + args[i] + "\"");
                msg.update(FIELD_PAYLOAD, args[i]);
                transport.send(msg);
                i++;
            }
        }
    ...
    void usage() {
        System.err.println(
                "Usage: java " + getClass().getName() + " [-service service] [-network network]");
        System.err.println("            [-daemon daemon] <subject> <payloads>");
        System.exit(-1);
    }
