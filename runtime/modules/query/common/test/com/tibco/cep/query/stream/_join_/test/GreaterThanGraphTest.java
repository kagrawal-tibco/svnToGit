...
*/
public class GreaterThanGraphTest {
    public static void main(String[] args) throws Exception {
        new GreaterThanGraphTest().test();
    }
    ...
    public void test() throws Exception {
        ...
        IndexedJoinNode join = new IndexedJoinNode(eeA, Operator.GREATER_THAN, eeB,
        ...
        EqualsGraphTest.EndNode endNode = new EqualsGraphTest.EndNode();
