...
public class AggrDistinctPartitionedStreamTest extends AbstractTest {
    ...
    public void test() throws Exception {
        ...
        try {
            ...
            itemInfos.put("count", new GroupAggregateItemInfo(new AggregateItemInfo(
                    CountDistinctAggregator.CREATOR, new DefaultTupleValueExtractor() {
                @Override
                public Object extract(GlobalContext globalContext,
                                      QueryContext queryContext, Tuple tuple) {
            ...
            itemInfos.put("sum", new GroupAggregateItemInfo(new AggregateItemInfo(
                    DoubleSumDistinctAggregator.CREATOR, new DefaultTupleValueExtractor() {
                @Override
                public Object extract(GlobalContext globalContext,
                                      QueryContext queryContext, Tuple tuple) {
                    return tuple.getColumn(1);
            ...
            itemInfos.put("avg", new GroupAggregateItemInfo(new AggregateItemInfo(
                    AverageDistinctAggregator.CREATOR, new DefaultTupleValueExtractor() {
                @Override
                public Object extract(GlobalContext globalContext,
                                      QueryContext queryContext, Tuple tuple) {
                    return tuple.getColumn(1);
            ...
            expectedResults.add(new Object[]{null, 2, 15.0, 7.5});
            expectedResults.add(new Object[]{4, 1, 0.0, 0.0});
            expectedResults.add(new Object[]{2, 1, 5.0, 5.0});
            expectedResults.add(new Object[]{0, 3, 6.0, 2.0});
            expectedResults.add(new Object[]{1, 1, 4.0, 4.0});
            ...
            answersOnDelete.add(new Object[]{0, 3, 6.0, 2.0});
            answersOnDelete.add(new Object[]{0, 2, 5.0, 2.5});
