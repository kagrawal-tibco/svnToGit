...
public class JoinedOrWithInStreamTest extends AbstractTest {
    ...
    public void test() {
        try {
            ...
            Source orderStream = new SourceImpl(null, orderInfo);
            Source priorityCustomerStream = new SourceImpl(new ResourceId("Souce"),
            ...
            JoinedStreamImpl joinedStream = new JoinedStreamImpl(master.getAgentService().getName(),
                    queryName, new ResourceId("Join"), joinSources, nestedSources, orExpression,
                    joinOutputInfo);
