...
SET HOSTPORT_RAW=localhost:5056
...
ECHO Default: -r localhost:5056 -d %BASEDIR% -g _default
goto eof
...
IF NOT EXIST "%CONFIG_SCRIPT%" (
    ...
    ECHO table create mytable tid long >> "%CONFIG_SCRIPT%"
    ECHO column create mytable value string >> "%CONFIG_SCRIPT%"
)
