...
public class Event {
    ...
    public String filterQuery(@PathParam("eventUri") String uri, @Context UriInfo info) throws Exception {

        String eventUri = "/" + uri.replaceAll("\\.", "/");
        ...
        ASEntityDao dao = AsAggregateFunctions.findDao(eventUri);
...
//                }
    ...
    public String showEventDefinition() {
        return("foo");
    }
