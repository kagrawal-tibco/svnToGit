...
import com.tibco.cep.webstudio.client.process.properties.general.ErrorEndEventGeneralProperty;

/**
 * This class is used to create the property tabs of error end event.
 * 
 * @author dijadhav
 * 
 */
public class ErrorEndEventPropertyTabSet extends PropertyTabSet {
	public ErrorEndEventPropertyTabSet(Property property) {
		super(property);
	}
	...
	public void createTabSet() {
		...
		if (property instanceof ErrorEndEventGeneralProperty) {
			createGeneralPropertyForm((ErrorEndEventGeneralProperty) property);
	 ...
	 * 
	 * @param errorEndEventGeneralProperty
	 */
	private void createGeneralPropertyForm(
			ErrorEndEventGeneralProperty errorEndEventGeneralProperty) {

		TextItem resourceTextItem = PropertyCommanFieldUtil.getResourceTextItem(
				errorEndEventGeneralProperty.getResource(),
		...
		generalForm.setItems(
				getNameItem(errorEndEventGeneralProperty.getName()),
				getLabelItem(errorEndEventGeneralProperty.getLabel()),
				resourceTextItem);
		...
		SectionStack sectionStack = PropertyCommanFieldUtil.getHelpContainer(
				errorEndEventGeneralProperty, processMessages);
