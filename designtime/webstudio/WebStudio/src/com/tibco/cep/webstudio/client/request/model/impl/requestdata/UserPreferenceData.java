 ...
 * @author Vikram Patil
 */
public class UserPreferenceData<D extends IRequestDataItem> extends DefaultRequestProject<D> {
	
	public void serialize(Document rootDocument, Node rootNode) {
		//Create <userPreference> element
		Element userPreferenceElement = rootDocument.createElement(XMLRequestBuilderConstants.USER_PREFERENCE_ELEMENT);
