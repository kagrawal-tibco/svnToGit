...
import static com.tibco.cep.webstudio.client.decisiontable.constraint.Operator.DONT_CARE_OPERATOR;
import static com.tibco.cep.webstudio.client.decisiontable.constraint.Operator.OR_OP;
import static com.tibco.cep.webstudio.client.decisiontable.constraint.Operator.RANGE_OPERATOR;
...
public class Expression {
	   ...
	   private Object[] operands = new Object[2];
	    ...
	    private DateTimeFormat format =DateTimeFormat.getFormat("yyyy-MM-dd'T'HH:mm:ss");
	    /**
	    			...
	    			try{
	    				...
	    				try { // try parsing it to Double
	    					...
	    					try {
								...
								operands[0] = format.parse(rangeEle.substring(index).trim());
	    			...
	    			try{    					
	    				...
	    				try { // try parsing it to Double
	    					...
	    					try {
	    						...
	    						operands[0] = format.parse("1601-01-01T00:00:00"); 
	        			    	operands[1] = format.parse("9999-12-31T00:00:00");
								operands[1] = format.parse(rangeEle.substring(index).trim());
							} catch (IllegalArgumentException e) {
