 ...
 */
public class BpmnSignalStartNodeUI extends TSCompositeNodeUI {
	public BpmnSignalStartNodeUI() {
	...
	private TSUIElement getCollapsedBodyElement(TSUIStyle style) {
		...
		TSBoundsUIElement innerTriangle= new TSPolygonUIElement("signalstarttriangle");
		...
		TSOvalUIElement outerOvalElement = new TSOvalUIElement("signalstartoval",
