...
public abstract class BpmnBaseStartEventNodeBuilder extends TSEllipseNodeBuilder
{
	/* 
	 * @inheritDoc
	 */
	...
	protected void initDefaultAttributes(TSAttributedObject o)
	{
		...
		o.setAttribute(BpmnNodeConstants.GRADIENT_COLOR_ENABLED, Boolean.valueOf(false));
		o.setAttribute(BpmnNodeConstants.GRADIENT_START_COLOR, new TSEColor(255, 255, 255));
		o.setAttribute(BpmnNodeConstants.GRADIENT_FINISH_COLOR, new TSEColor(255, 255, 255));
		o.setAttribute(BpmnNodeConstants.GRADIENT_DIRECTION, Integer.valueOf(TSUIConstants.TOP_TO_BOTTOM));
		
		o.setAttribute(BpmnNodeConstants.BORDER_COLOR, new TSEColor(255, 153, 0));
