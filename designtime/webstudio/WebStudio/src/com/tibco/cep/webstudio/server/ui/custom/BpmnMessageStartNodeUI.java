 ...
 */
public class BpmnMessageStartNodeUI extends TSCompositeNodeUI {
	public BpmnMessageStartNodeUI() {
	...
	private TSUIElement getCollapsedBodyElement(TSUIStyle style) {
		...
		TSOvalUIElement ovalElement = new TSOvalUIElement("shape",
				new TSUIElementPoint(0, 10, 0, -10), new TSUIElementPoint(
						0, -10, 0, 10));
		((TSOvalUIElement) ovalElement).setLineWidthTransformEnabled(true);
		...
		style.setProperty(rectangle, TSUIStyleConstants.LINE_WIDTH, 0.5);
		...
		style.setProperty(innerTriangleEdge1, TSUIStyleConstants.LINE_COLOR, "<"
				+ BpmnNodeConstants.BORDER_COLOR + ">");
		style.setProperty(innerTriangleEdge1, TSUIStyleConstants.LINE_WIDTH,
				0.5);
		...
		style.setProperty(innerTriangleEdge2, TSUIStyleConstants.LINE_COLOR, "<"
				+ BpmnNodeConstants.BORDER_COLOR + ">");
		style.setProperty(innerTriangleEdge2, TSUIStyleConstants.LINE_WIDTH,
				0.5);
		style.setProperty(innerTriangleEdge2, TSUIStyleConstants.LINE_STYLE, "<"
				+ BpmnNodeConstants.BORDER_STYLE + ">");
		
		style.setProperty(ovalElement, TSUIStyleConstants.FILL_COLOR, "<"
				+ BpmnNodeConstants.TRANSPARENT_COLOR + ">");
		style.setProperty(ovalElement, TSUIStyleConstants.LINE_COLOR, "<"
				+ BpmnNodeConstants.BORDER_COLOR + ">");
		style.setProperty(ovalElement, TSUIStyleConstants.LINE_WIDTH,
				Integer.valueOf(1));
		style.setProperty(ovalElement, TSUIStyleConstants.LINE_STYLE, "<"
				+ BpmnNodeConstants.BORDER_STYLE + ">");

	
		group.addElement(ovalElement);
