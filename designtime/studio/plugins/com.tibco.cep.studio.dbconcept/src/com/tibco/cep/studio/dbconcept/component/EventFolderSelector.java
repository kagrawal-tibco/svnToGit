...
public class EventFolderSelector extends FolderSelector{
	public EventFolderSelector(Shell parent, String currentProjectName) {
		super(parent, currentProjectName);
	}

	@Override
	protected String getMessage() {
		return Messages.getString("Event_Folder_Selector_Dialog_Title");
	}

	@Override
	protected String getSelectionErrorMsg() {
		return Messages.getString("Event_Folder_Selector_Dialog_Message");
	}

	@Override
	protected String getSelectionMsgFormat() {
		return Messages.getString("Event_Folder_Selector_Message_format");
	}

	@Override
	protected String getTitle() {
		return Messages.getString("Event_Folder_Selector_Error_Message");
	}
