...
public final class TestResultDetailsPart implements IFormPart, IPartSelectionListener {
 ...
 */	
	public TestResultDetailsPart(IManagedForm mform, ScrolledPageBook pageBook) {
 ...
 */
	public TestResultDetailsPart(IManagedForm mform, Composite parent, int style) {
 ...
 */
	public void registerPage(AbstractSashForm form, Object objectClass, IDetailsPage page) {
		if(page instanceof AbstractResultDetailsPage) {
			((AbstractResultDetailsPage) page).setForm(form);
		}
 ...
 */
	...
	private void createEmptyDetailsInfo(FormToolkit toolkit, Composite composite) {
		...
		txt	.setText(Messages.getString("result.data.details.info"), false, false);
