...
import com.tibco.cep.studio.dashboard.ui.statemachinecomponent.forms.IndicatorAlertSettingsForm;

public class IndicatorAlertsSection extends AbstractFormPropertySection {

	@Override
	protected BaseForm getForm(Composite parent) {
		return new IndicatorAlertSettingsForm(getWidgetFactory(),parent);
	}
	...
	protected LocalElement getTargetLocalElement() throws Exception {
		...
		return StateMachineComponentHelper.getIndicatorSeriesConfig((LocalStateVisualization) targetElement);
	}
}
