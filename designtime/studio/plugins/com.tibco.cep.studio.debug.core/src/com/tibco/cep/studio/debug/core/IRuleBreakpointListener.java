 ...
 * @since 2.0
 */
public interface IRuleBreakpointListener {
	 ...
	 */
	public void addingBreakpoint(IRuleRunTarget target, IRuleBreakpoint breakpoint);
	 ...
	 * @since 3.0
	 */
	public int installingBreakpoint(IRuleDebugTarget target, IRuleBreakpoint breakpoint, String type);
	 ...
	 * @param breakpoint Java breakpoint
	 */
	public void breakpointInstalled(IRuleRunTarget target, IRuleBreakpoint breakpoint);
	 ...
	 * @since 3.0
	 */
	public int breakpointHit(IRuleDebugThread thread, IRuleBreakpoint breakpoint);	
	 ...
	 * @param breakpoint Java breakpoint
	 */
	public void breakpointRemoved(IRuleRunTarget target, IRuleBreakpoint breakpoint);	
	 ...
	 *  condition
	 */
	public void breakpointHasRuntimeException(IRuleBreakpoint breakpoint, DebugException exception);
	 ...
	 */
//	public void breakpointHasCompilationErrors(IRuleBreakpoint breakpoint, Message[] errors);
}
