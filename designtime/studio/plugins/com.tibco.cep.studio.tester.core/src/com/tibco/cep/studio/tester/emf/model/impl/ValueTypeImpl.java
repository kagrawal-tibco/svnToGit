 ...
 * <ul>
 *   <li>{@link com.tibco.cep.studio.tester.emf.model.impl.ValueTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueTypeImpl extends EObjectImpl implements ValueType {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VALUE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.VALUE_TYPE__VALUE:
				return getValue();
		}
