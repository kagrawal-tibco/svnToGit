 ...
 * <!-- end-user-doc -->
 * @see com.tibco.cep.studio.tester.emf.model.ModelPackage#getTypeType()
...
public enum TypeType implements Enumerator {
	 ...
	 * @ordered
	 */
	RULEFUNCTION(1, "RULEFUNCTION", "RULEFUNCTION");
	 ...
	 * @ordered
	 */
	public static final int RULEFUNCTION_VALUE = 1;
