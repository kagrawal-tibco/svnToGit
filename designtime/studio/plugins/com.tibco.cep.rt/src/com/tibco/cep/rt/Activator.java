...
public class Activator extends Plugin {
	//static BEProperties properties = BEProperties.loadDefault();
	//protected static String JAVA_TARGET_VERSION = properties.getString("be.codegen.javaTargetVersion", "1.5");
    protected static String charset = "UTF-8";

	// The plug-in ID
	public static final String PLUGIN_ID = "com.tibco.cep.rt";
