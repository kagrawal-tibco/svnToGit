...
import com.tibco.cep.studio.ui.filter.ObjectCacheCDDOnly;
 ...
 *
 */
public class ObjectCacheCDDResourceSelector extends AbstractResourceElementSelector implements  ISelectionStatusValidator {
	 ...
	 * @param extension
	 */
	public ObjectCacheCDDResourceSelector(Shell parent,
			                String title, 
			                String message, 
			                IProject project, 
        ...
        addFilter(new ObjectCacheCDDOnly());
        setValidator(this);
