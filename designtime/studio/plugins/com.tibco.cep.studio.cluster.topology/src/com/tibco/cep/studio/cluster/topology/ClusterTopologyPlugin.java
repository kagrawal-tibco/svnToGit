package com.tibco.cep.studio.cluster.topology;
 ...
 */
public class ClusterTopologyPlugin extends AbstractUIPlugin {

	public static final String PLUGIN_ID = "com.tibco.cep.studio.cluster.topology";
		

	// The shared instance
	private static ClusterTopologyPlugin plugin;
	 ...
	 */
	public static ClusterTopologyPlugin getDefault() {
		return plugin;
	}
	...
	public static ImageIcon  createImageIcon(String file)  {
		...
		try{
			InputStream resource = ClusterTopologyPlugin.class.getClassLoader().getResourceAsStream(ImagePath+file);
			if (resource == null) {
