 ...
 *
 */
public class ExitActionPropertySection extends AbstractStateMachineRulePropertySection {
		...
		if(eObject instanceof State){
			try{
				...
				if(rule == null){
					...
					state.setExitAction((Rule)rule);
				}
				rule.setOwnerProjectName(stateMachine.getOwnerProjectName());
				String feature = StatesPackage.eINSTANCE.getState_ExitAction().getName();
