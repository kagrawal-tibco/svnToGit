 ...
 *
 */
public class EntryActionPropertySection extends AbstractStateMachineRulePropertySection {
		...
		if(eObject instanceof State){
			try{
				...
				if(rule == null){
					...
					state.setEntryAction((Rule)rule);
				}
				rule.setOwnerProjectName(stateMachine.getOwnerProjectName());
				String feature = StatesPackage.eINSTANCE.getState_EntryAction().getName();
