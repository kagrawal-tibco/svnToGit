...
public class StateEntityContentProvider implements ITreeContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if(parentElement instanceof StateMachine){
			EList<StateEntity> entities = ((StateMachine)(parentElement)).getStateEntities();
			StudioNavigatorNode[] attributes = new StudioNavigatorNode[entities.size()];
	...
	public boolean hasChildren(Object element) {
		if(((StateEntityNode)element).getEntity() instanceof StateComposite){
			StateComposite stateComposite = (StateComposite) ((StateEntityNode)element).getEntity();
