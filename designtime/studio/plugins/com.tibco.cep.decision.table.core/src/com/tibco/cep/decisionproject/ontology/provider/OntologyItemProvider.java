...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionproject.ontology.Ontology} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OntologyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ontology_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ontology_resource_feature", "_UI_Ontology_type"),
				 OntologyPackage.Literals.ONTOLOGY__RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected Collection<? extends EStructuralFeature> getChildrenFeatures(
			Object object) {
		// cache all implementations list here 		
		...
		if (dp != null){
			...
			if (implementationList != null){
				...
				implementationList = new ArrayList<AbstractResource>();
			}
		
		}		
		if (childrenFeatures == null) {
			super.getChildrenFeatures(object);			
			childrenFeatures.add(OntologyPackage.Literals.ONTOLOGY__RESOURCE);
