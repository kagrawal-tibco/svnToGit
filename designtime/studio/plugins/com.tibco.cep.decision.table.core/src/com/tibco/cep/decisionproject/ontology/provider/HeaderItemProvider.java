...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionproject.ontology.Header} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HeaderItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntologyPackage.Literals.HEADER__PROPERTY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Header.class)) {
			case OntologyPackage.HEADER__PROPERTY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.HEADER__PROPERTY,
				 DtmodelFactory.eINSTANCE.createProperty()));
	}
