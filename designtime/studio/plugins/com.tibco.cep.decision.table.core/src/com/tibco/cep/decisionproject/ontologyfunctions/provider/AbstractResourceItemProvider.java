...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionproject.ontologyfunctions.AbstractResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractResourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OntologyFunctionsPackage.Literals.ABSTRACT_RESOURCE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns AbstractResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AbstractResource"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractResource_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractResource.class)) {
			case OntologyFunctionsPackage.ABSTRACT_RESOURCE__NAME:
