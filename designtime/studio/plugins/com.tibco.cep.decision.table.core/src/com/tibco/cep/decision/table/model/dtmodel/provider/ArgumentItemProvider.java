...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decision.table.model.dtmodel.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_direction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_direction_feature", "_UI_Argument_type"),
				 DtmodelPackage.Literals.ARGUMENT__DIRECTION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DtmodelPackage.Literals.ARGUMENT__PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((Argument)object).getDirection();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DtmodelPackage.Literals.ARGUMENT__PROPERTY,
