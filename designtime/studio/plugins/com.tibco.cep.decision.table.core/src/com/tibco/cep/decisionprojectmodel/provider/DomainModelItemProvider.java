...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionprojectmodel.DomainModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DomainModelItemProvider
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainModel_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainModel_version_feature", "_UI_DomainModel_type"),
				 DecisionProjectModelPackage.Literals.DOMAIN_MODEL__VERSION,
				 true,
				 false,
				 false,
	...
	protected void addLastModifiedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DomainModel_lastModifiedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DomainModel_lastModifiedBy_feature", "_UI_DomainModel_type"),
				 DecisionProjectModelPackage.Literals.DOMAIN_MODEL__LAST_MODIFIED_BY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DecisionProjectModelPackage.Literals.DOMAIN_MODEL__DOMAIN);
		}
	...
	public String getText(Object object) {
		DomainModel domainModel = (DomainModel)object;
		return getString("_UI_DomainModel_type") + " " + domainModel.isModified();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DecisionProjectModelPackage.Literals.DOMAIN_MODEL__DOMAIN,
				 DomainModelFactory.eINSTANCE.createDomain()));
	}
