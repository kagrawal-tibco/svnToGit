...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionproject.ontology.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createFolder()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createConcept()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createRuleSet()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createRuleSetParticipant()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createRuleFunction()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createDTRule()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 OntologyFactory.eINSTANCE.createPrimitiveHolder()));

		newChildDescriptors.add
			(createChildParameter
				(OntologyPackage.Literals.ARGUMENT__ARGUMENT_ENTRY,
				 DtmodelFactory.eINSTANCE.createTable()));
	}
