...
/**
 * This is the item provider adapter for a {@link com.tibco.cep.decisionproject.ontology.Folder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Folder_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Folder_resource_feature", "_UI_Folder_type"),
				 OntologyPackage.Literals.FOLDER__RESOURCE,
				 true,
				 false,
				 true,
				 null,
...
//		return overlayImage(object, PlatformUI.getWorkbench().getSharedImages().getImage(ISharedImages.IMG_OBJ_FOLDER));
	...
	protected Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OntologyPackage.Literals.FOLDER__RESOURCE);
