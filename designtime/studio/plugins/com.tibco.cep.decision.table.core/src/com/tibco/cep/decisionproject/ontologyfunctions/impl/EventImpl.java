 ...
 * <ul>
 *   <li>{@link com.tibco.cep.decisionproject.ontologyfunctions.impl.EventImpl#getFunctionLabel <em>Function Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EventImpl extends AbstractResourceImpl implements Event {
	...
	protected EClass eStaticClass() {
		return OntologyFunctionsPackage.Literals.EVENT;
	}
	...
	public NotificationChain basicSetFunctionLabel(FunctionLabel newFunctionLabel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OntologyFunctionsPackage.EVENT__FUNCTION_LABEL, oldFunctionLabel, newFunctionLabel);
	...
	public void setFunctionLabel(FunctionLabel newFunctionLabel) {
		if (newFunctionLabel != functionLabel) {
			...
			if (functionLabel != null)
				msgs = ((InternalEObject)functionLabel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OntologyFunctionsPackage.EVENT__FUNCTION_LABEL, null, msgs);
			if (newFunctionLabel != null)
				msgs = ((InternalEObject)newFunctionLabel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OntologyFunctionsPackage.EVENT__FUNCTION_LABEL, null, msgs);
			msgs = basicSetFunctionLabel(newFunctionLabel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologyFunctionsPackage.EVENT__FUNCTION_LABEL, newFunctionLabel, newFunctionLabel));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntologyFunctionsPackage.EVENT__FUNCTION_LABEL:
