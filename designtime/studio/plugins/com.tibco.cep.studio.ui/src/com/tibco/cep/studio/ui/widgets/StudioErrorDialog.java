 ...
 * @author sasahoo
 */
public class StudioErrorDialog extends IconAndMessageDialog {
	...
	public static int openError(Shell parent, String dialogTitle,String message, String detailsDescription) {
		StudioErrorDialog dialog = new StudioErrorDialog(parent, dialogTitle, message, detailsDescription);
		return dialog.open();
	}
	...
	public static int openError(Shell parentShell, String title, String message, IStatus status, int displayMask) {
		StudioErrorDialog dialog = new StudioErrorDialog(parentShell, title, message,status, displayMask);
		return dialog.open();
	}
	 ...
	 * @param displayMask
	 */
	public StudioErrorDialog(Shell parentShell, String dialogTitle, String message, IStatus status, int displayMask) {
		super(parentShell);
	 ...
	 * @param detailsDescription
	 */
	public StudioErrorDialog(Shell parentShell, String title, String message,String detailsDescription) {
		super(parentShell);
