 ...
 * 
 */
public class ConvertToJavaProjectAction implements IWorkbenchWindowActionDelegate, 
	...
	public void run(IAction action) {
		try {
			...
			MessageDialog.openError(fWindow.getShell(), "Convert to Java Project", e.getMessage());
			run(action);
		}
	}
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		try {
			...
			action.setEnabled(fProject != null && fProject.isAccessible() && !fProject.hasNature(JavaCore.NATURE_ID));
		} catch (Exception e) {
			StudioUIPlugin.log("Failed.");
			StudioUIPlugin.log(e);
		}
	}
