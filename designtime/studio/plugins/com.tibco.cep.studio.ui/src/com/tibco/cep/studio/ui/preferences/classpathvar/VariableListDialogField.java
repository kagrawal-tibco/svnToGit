...
import com.tibco.cep.studio.ui.util.PixelConverter;


public class VariableListDialogField<E> extends VariableDialogField {
	...
	private IVariableListAdapter<E> fListAdapter;
	 ...
	 * @param lprovider
	 */
	public VariableListDialogField(IVariableListAdapter<E> adapter, String[] buttonLabels, ILabelProvider lprovider) {
		super();
	...
	public Control getListControl(Composite parent) {
		if (fTableControl == null) {
			if (fTableColumns == null) {
				...
				ListDialogTableLayoutComposite composite= new ListDialogTableLayoutComposite(parent, SWT.NONE);
	...
	*/
	...
	class ListDialogTableLayoutComposite extends Composite {
		private List<ColumnLayoutData> columns= new ArrayList<ColumnLayoutData>();
		public ListDialogTableLayoutComposite(Composite parent, int style) {
			super(parent, style);
