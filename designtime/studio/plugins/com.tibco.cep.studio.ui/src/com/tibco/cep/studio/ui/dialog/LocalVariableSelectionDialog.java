...
public class LocalVariableSelectionDialog extends SelectionStatusDialog {

	private List<VariableDefinition> varList;
	private TreeViewer treeViewer;
	private Object selectedObj;
	private String projectName;
	private GeneralIndexLabelProvider labelProvider;

	public LocalVariableSelectionDialog(Shell parent, String title, String message, String projectName, List<VariableDefinition> varList) {
		super(parent);
		setTitle(title);
		setMessage(message);
	...
	protected Control createDialogArea(Composite parent) {
        ...
        if (varList.isEmpty()) {
            ...
            updateStatus(new Status(Status.ERROR, StudioUIPlugin.PLUGIN_ID,
            		Status.OK/*Status.ERROR*/, "No concept variables in scope", null));
	...
	private TreeViewer createTreeViewer(Composite composite) {
		...
		qNameTreeViewer.setInput(this.varList);
