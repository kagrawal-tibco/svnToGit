...
public class GatewayGenerator extends AbstractFlowElementGenerator
		implements BaseGenerator {
	
	

	public GatewayGenerator(EObject gateway, BaseGenerator parent,
			CodeGenContext ctx, IProgressMonitor monitor, boolean overwrite) {
		super(gateway, parent, ctx, monitor, overwrite);
