...
public class IdentityRefactoringParticipant extends AbstractSharedResourceRefactoring {
	
	public IdentityRefactoringParticipant() {
		super();
	}
	...
	public Change createPreChange(IProgressMonitor pm) throws CoreException,
		...
		if (resource instanceof IFolder) {
			...
			return processIDConfig(elementToRefactor, fProjectName, pm);
		}
...
//		}
		...
		processIDConfigElement(fProjectName, change, file, modelmgr, elementToRefactor);
		return change;
	}
	 ...
	 */
	public Change processIDConfig(Object elementToRefactor, 
			                                  String projectName, 
		...
		CompositeChange compositeChange = new CompositeChange("Identity Configuration changes:");
		...
		for (IFile element : fileList) {
			...
			IdentityConfigModelMgr modelmgr = new IdentityConfigModelMgr(element);
			modelmgr.parseModel();
			processIDConfigElement(fProjectName, compositeChange, element, modelmgr, elementToRefactor);
		}
	...
	public String getName() {
		return "Identity Configuration Refactoring participant";
	}
	 ...
	 * @throws CoreException
	 */
	private void processIDConfigElement(String projectName,
			                                 CompositeChange compositeChange,
			                                 IFile sharedFile,
			                                 IdentityConfigModelMgr modelmgr, 
			                                 Object elementToRefactor) throws CoreException {
		boolean changed = false;
//	    String fName = sharedFile.getName().replace("." + getExtension(), "");
		//Handling ID Config rename 
