...
public class RVTransportRefactoringParticipant extends AbstractSharedResourceRefactoring {
	
	public RVTransportRefactoringParticipant() {
		super();
	}
	...
	public Change createPreChange(IProgressMonitor pm) throws CoreException,
		...
		if (resource instanceof IFolder) {
			...
			return processRVTransportConfig(elementToRefactor, fProjectName, pm);
		}
...
//		}
		...
		processRVTransportConfigElement(fProjectName, change, file, modelmgr, elementToRefactor);
		return change;
	}
	 ...
	 */
	public Change processRVTransportConfig(Object elementToRefactor, 
			                                  String projectName, 
		...
		CompositeChange compositeChange = new CompositeChange("RV Transport Configuration changes:");
		...
		for (IFile element : fileList) {
			...
			RvTransportModelMgr modelmgr = new RvTransportModelMgr(element);
			modelmgr.parseModel();
			processRVTransportConfigElement(fProjectName, compositeChange, element, modelmgr, elementToRefactor);
		}
	...
	public String getName() {
		return "RV Transport Configuration Refactoring participant";
	}
	 ...
	 * @throws CoreException
	 */
	private void processRVTransportConfigElement(String projectName,
			                                 CompositeChange compositeChange,
			                                 IFile sharedFile,
			                                 RvTransportModelMgr modelmgr, 
