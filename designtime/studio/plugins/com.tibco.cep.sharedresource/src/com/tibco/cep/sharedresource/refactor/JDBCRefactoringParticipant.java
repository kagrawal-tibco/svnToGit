...
public class JDBCRefactoringParticipant extends AbstractSharedResourceRefactoring {
	
	public JDBCRefactoringParticipant() {
		super();
	}
	...
	public Change createPreChange(IProgressMonitor pm) throws CoreException,
		...
		if (resource instanceof IFolder) {
			...
			return processJdbcConfig(elementToRefactor, fProjectName, pm);
		}
...
//		}
		...
		processJdbcConfigElement(fProjectName, change, file, modelmgr, elementToRefactor);
		return change;
	}
	 ...
	 */
	public Change processJdbcConfig(Object elementToRefactor, 
			                                  String projectName, 
		...
		CompositeChange compositeChange = new CompositeChange("JDBC Configuration changes:");
		...
		for (IFile element : fileList) {
			...
			JdbcConfigModelMgr modelmgr = new JdbcConfigModelMgr(element);
			modelmgr.parseModel();
			processJdbcConfigElement(fProjectName, compositeChange, element, modelmgr, elementToRefactor);
		}
	...
	public String getName() {
		return "JDBC Configuration Refactoring participant";
	}
	 ...
	 * @throws CoreException
	 */
	private void processJdbcConfigElement(String projectName,
			                                 CompositeChange compositeChange,
			                                 IFile sharedFile,
			                                 JdbcConfigModelMgr modelmgr, 
			                                 Object elementToRefactor) throws CoreException {
		boolean changed = false;
	    String fName = sharedFile.getName().replace("." + getExtension(), "");
		//Handling JDBC Config rename 
