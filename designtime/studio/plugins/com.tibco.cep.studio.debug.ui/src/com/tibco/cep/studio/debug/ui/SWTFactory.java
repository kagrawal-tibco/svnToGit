...
public class SWTFactory {
	...
	public static void showPreferencePage(String id) {
		PreferencesUtil.createPreferenceDialogOn(StudioDebugUIPlugin.getActiveWorkbenchShell(), id, new String[] { id }, null).open();
	}
	...
	public static void showPreferencePage(String page_id, String[] page_filters) {
		PreferencesUtil.createPreferenceDialogOn(StudioDebugUIPlugin.getActiveWorkbenchShell(), page_id, page_filters, null).open();
	}
