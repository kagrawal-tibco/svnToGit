 ...
 * Date: Nov 26, 2008
 */
public class CurvedEdgeUI extends TSECurvedEdgeUI {
    ...
    public CurvedEdgeUI(boolean drawHollowArrows)
    {
    ...
    {
        if (drawHollowArrows) {
            super.drawLineWithArrow(graphics,
                fromX,
                fromY,
                toX,
                toY,
            ...
            this.internalDrawLineWithArrow(graphics,
                fromX,
                fromY,
                toX,
                toY,
    ...
    protected void internalDrawLineWithArrow(TSEGraphics graphics,
                                         double fromX,
                                         double fromY,
                                         double toX,
                                         double toY,
