...
public class FilterNodeCreator extends TSNodeBuilder {

	private static final long serialVersionUID = 1L;
	private String nodeName;
	private GatewayType gatewayType;
	
	public FilterNodeCreator(String name, GatewayType gateWayType) {
		this.nodeName = name;
	...
	public TSENode addNode(TSEGraph graph)
	{
		...
		tsNode.setShape(TSPolygonShape.fromString("[ 4 (25,25) (75,25) (100,75) (0,75) ]"));
