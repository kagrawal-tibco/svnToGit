...
public class PanAction extends Action {
	...
	public PanAction( IWorkbenchPage page) {
		super("", SWT.NONE);
		this.page = page;
		setText(Messages.getString("pan"));
		setToolTipText(Messages.getString("pan.tooltip"));
		setImageDescriptor(DiagrammingPlugin.getDefault().getImageDescriptor("icons/pan.gif"));
	}
