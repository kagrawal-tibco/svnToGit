...
public class ScatterTypeProcessor extends BaseChartComponentTypeProcessor {
	...
	public boolean isAcceptable(LocalElement localElement) throws Exception {
		...
		if (types.size() == 1 && types.contains(BEViewsElementNames.SCATTER_CHART_VISUALIZATION) == true){
			return true;
		}
		return false;
	}
	...
	public LocalElement createNativeVisualization(LocalElement parent, String name) throws Exception {
		LocalElement visualization = parent.createLocalElement(BEViewsElementNames.SCATTER_CHART_VISUALIZATION);
