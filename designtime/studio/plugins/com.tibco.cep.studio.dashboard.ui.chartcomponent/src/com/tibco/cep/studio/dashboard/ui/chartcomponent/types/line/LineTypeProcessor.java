...
public class LineTypeProcessor extends BaseChartComponentTypeProcessor {
	...
	public boolean isAcceptable(LocalElement localElement) throws Exception {
		...
		if (types.size() == 1 && types.contains(BEViewsElementNames.LINE_CHART_VISUALIZATION) == true){
			return true;
		}
		return false;
	}
	...
	public LocalElement createNativeVisualization(LocalElement parent, String name) throws Exception {
		LocalElement visualization = parent.createLocalElement(BEViewsElementNames.LINE_CHART_VISUALIZATION);
