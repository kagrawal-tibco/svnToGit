...
public abstract class InputHandler extends KeyAdapter
{
    ...
    public static final ActionListener SELECT_ALL = new select_all(true);
	...
	{
		Enumeration<String> iter = getActions();
    ...
    public static class select_all implements ActionListener
    {
        ...
        public select_all(boolean select)
        {
            this.select = select;
        }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            JEditTextArea textArea = getTextArea(evt);
            if(select) {
                            textArea.select(0, textArea.getDocumentLength());
                        } else {
                            textArea.setCaretPosition(0);
                        }
        }
    }
    // END CHANGE TWH 2/19/02
	...
	public static class backspace implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			if(!textArea.isEditable())
			{
                // TIBCO Change, allow more flexibility here.
                textArea.editedNonEditable();
                // end TIBCO Change
				return;
			}
	...
	public static class backspace_word implements ActionListener
	{
		public void actionPerformed(ActionEvent evt)
		{
			...
			if(caret == 0)
			{
				if(lineStart == 0)
				{
                    // TIBCO change -- allow more flexibility.
					textArea.badEditAttempted();
                    // end TIBCO change
					return;
				}
				caret--;
	...
	public static class end implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent evt)
		{
            ...
            // This was causing a crash for short edit areas.
