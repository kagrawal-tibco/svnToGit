...
import com.tibco.cep.mapper.xml.xdata.bind.UnknownBinding;
 ...
 */
public class UnknownStatementPanel implements StatementPanel {
   public UnknownStatementPanel() {
   }
   ...
   public Class<UnknownBinding> getHandlesBindingClass() {
      return UnknownBinding.class;
   }
