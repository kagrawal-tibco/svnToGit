...
public class DecisionTreeDiagramSearchDialog extends DiagramSearchDialog implements ModifyListener, SelectionListener {
	 ...
	 * @param dialogTitle
	 */
	public DecisionTreeDiagramSearchDialog(IWorkbenchPage page, String dialogTitle, DiagramSearchAction action) {
