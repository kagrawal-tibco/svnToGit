 ...
 */
public class DecisionTreeUIPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.tibco.cep.decision.tree.ui";
	
	// The shared instance
	private static DecisionTreeUIPlugin plugin;
	
	public static boolean DEBUG = false;
	/**
	 * The constructor
	 */
	public DecisionTreeUIPlugin() {
	}
	 ...
	 */
	public static DecisionTreeUIPlugin getDefault() {
		return plugin;
	}
