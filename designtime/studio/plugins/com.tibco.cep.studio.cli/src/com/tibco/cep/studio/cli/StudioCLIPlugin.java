package com.tibco.cep.studio.cli;
 ...
 */
public class StudioCLIPlugin extends Plugin  {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.tibco.cep.studio.cli";

	// The shared instance
	private static StudioCLIPlugin plugin;
	 ...
	 */
	public static StudioCLIPlugin getDefault() {
		return plugin;
	}
