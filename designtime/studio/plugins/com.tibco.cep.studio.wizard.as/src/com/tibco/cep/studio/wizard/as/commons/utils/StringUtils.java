...
public class StringUtils {
	...
	public static Properties toProperties(String props) {
		...
		try {
			...
			throw new RuntimeException(Messages.getString("StringUtils.convert_str_to_props"), e); //$NON-NLS-1$
		}
		return p;
	}
	...
	public static void replaceStringInFile(String fileName, String targetString, String replacementString) {
		...
		try {
			...
			throw new RuntimeException(Messages.getString("StringUtils.failed_replace_str_in_file", fileName), e); //$NON-NLS-1$
		}
		finally {
			try {
				bufferedWriter.flush();
