 ...
 *
 */
public class StringXSDResourceImpl extends XSDResourceImpl {
	...
	public StringXSDResourceImpl() {
		super();
		// TODO Auto-generated constructor stub
	}

	public StringXSDResourceImpl(URI uri, String schemaContents) {
		super(uri);
		this.stringSchema = schemaContents;
	}
	...
	protected void doLoad(InputSource inputSource, Map<?, ?> options)
			throws IOException {
		generateXsdSchema(stringSchema);
	}
	
	public void generateXsdSchema(String stringSchema){
		
		InputSource inputSource;
		HashMap<Object, Object> options = new HashMap<>();
		try {
			InputStream byteStream = new ByteArrayInputStream(stringSchema.getBytes(ModelUtils.DEFAULT_ENCODING));
