...
/**
 * @author pdhar
 * This class extends org.eclipse.epf.common.utils.StringMatcher which is a documented
 * public API class
 *
 */
public class StringPatternMatcher {
	 ...
	 */
	public StringPatternMatcher.Position find(String text, int start, int end) {
		if (text == null)
	...
	/**
	 * StringPatternMatcher constructor takes in a String object that is a simple 
	 ...
	 *
	 * If invoking the StringPatternMatcher with string literals in Java, don't forget
	 * escape characters are represented by "\\".
	 *
	 * @param pattern the pattern to match text with
	 * @param ignoreCase if true, case is ignored
	 * @param ignoreWildCards if true, wild cards and their escape sequences are ignored
	 * 		  (everything is taken literally).
	 */
	public StringPatternMatcher(String pattern, boolean ignoreCase, boolean ignoreWildCards) {
		if (pattern == null)
			throw new IllegalArgumentException();
