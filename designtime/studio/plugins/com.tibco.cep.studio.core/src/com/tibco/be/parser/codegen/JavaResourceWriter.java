...
public class JavaResourceWriter {
	...
	public JavaResourceWriter(String shortName, String javaPackageName, File targetDir, String entityPath, char separator) {
	...
	public JavaResourceWriter(String shortName, String javaPackageName, JavaFolderLocation targetDir,String entityPath, char separator) {
		this.shortName = shortName;
		this.packageName = javaPackageName;
		this.fileBuffer = new byte[0];
	...
	public JavaResourceWriter(String shortName, String javaPackageName,String entityPath) {
	...
	public void writeFile() throws IOException {
		...
		File outFile = new File(outFileDir, getShortName());
	...
	public void writeStream() throws IOException {
		JavaFileLocation outFile = targetDirLocation.addFile(getPackage(), getShortName());
