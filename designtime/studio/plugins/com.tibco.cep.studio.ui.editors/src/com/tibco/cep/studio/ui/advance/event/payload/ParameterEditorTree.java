...
//      m_owner = owner;
     ...
     // ParameterPayloadNode root = new ParameterPayloadNode(owner);
      PayloadTreeModelParent root = new PayloadTreeModelParent(null, null, null, null, owner);
...
*/
  ...
  /* XsdContentModelPath getContentModelPathForTreePath(TreePath path) {
      ...
      ParameterPayloadNode pn = (ParameterPayloadNode) path.getLastPathComponent();
