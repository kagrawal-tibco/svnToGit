 ...
 *@author sasahoo 
 */
public final class PayloadDetailsPart implements IFormPart, IPartSelectionListener {
 ...
 */	
	...
	public PayloadDetailsPart(IManagedForm mform, ScrolledPageBook pageBook) {
 ...
 */
	public PayloadDetailsPart(IManagedForm mform, Composite parent, int style) {
 ...
 */
	...
	private void createEmptyDetailsInfo(FormToolkit toolkit, Composite composite) {
		...
		txt	.setText(""/*Messages.getString("CHANNEL_DETAILS_PART_EMPTY_MESSAGE")*/, false, false);
