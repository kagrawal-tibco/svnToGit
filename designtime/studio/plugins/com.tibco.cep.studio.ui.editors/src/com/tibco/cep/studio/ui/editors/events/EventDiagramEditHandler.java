 ...
 *
 */
public class EventDiagramEditHandler extends Action{
	
		private TSEGraphManager graphManager;
		private DrawingCanvas canvas;
		private LayoutManager layoutManager;
		private DiagramManager diagramManager;
	    private EventDiagramEditor editor;
		 ...
		 * @param layoutManager
		 */
		public EventDiagramEditHandler(String id, 
				EventDiagramEditor editor) {
			super();
			setId(id);
			this.editor = editor;
		}
		...
		public void run() {
			...
			diagramManager = (EventDiagramManager) editor.getDiagramManager();
