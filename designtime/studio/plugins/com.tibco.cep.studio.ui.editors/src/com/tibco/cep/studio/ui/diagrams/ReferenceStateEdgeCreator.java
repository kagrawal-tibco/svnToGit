 ...
 *
 */
public class ReferenceStateEdgeCreator extends TSEdgeBuilder {
	...
	public TSEEdge addEdge(TSEGraphManager arg0, TSENode arg1, TSENode arg2) {
		...
		TSEEdgeUI edgeUI = new UMLCurvedEdgeUI(UMLCurvedEdgeUI.REFERENCE);
		edge.setName("Reference");
		edge.addLabel().setText("Reference");
