 ...
 *
 */
public class InheritanceStateEdgeCreator extends TSEdgeBuilder {
	...
	public TSEEdge addEdge(TSEGraphManager arg0, TSENode arg1, TSENode arg2) {
		...
		TSEEdgeUI edgeUI = new UMLCurvedEdgeUI(UMLCurvedEdgeUI.INHERITANCE);
		edge.setName("Inherits From");
		edge.addLabel().setText("Inherits From");
