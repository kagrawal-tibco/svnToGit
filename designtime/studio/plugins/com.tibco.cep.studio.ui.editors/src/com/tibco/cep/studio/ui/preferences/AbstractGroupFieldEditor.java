 ...
 *
 */
public abstract class AbstractGroupFieldEditor extends FieldEditor implements IPreferences{
     ...
     */
    protected AbstractGroupFieldEditor() {
    }

    protected AbstractFieldEditorPreferencePage preferencePage;
    /**
     ...
     */
    public AbstractGroupFieldEditor(String name, String labelText, int numColumns,
            String[][] labelAndValues, Composite parent,AbstractFieldEditorPreferencePage preferencePage) {
        this(name, labelText, numColumns, labelAndValues, parent, false,preferencePage);
    }
    ...
    protected void initGroupField(Composite parent){
     ...
     */
    protected abstract Composite getRadioBoxControl(Composite parent);
}
