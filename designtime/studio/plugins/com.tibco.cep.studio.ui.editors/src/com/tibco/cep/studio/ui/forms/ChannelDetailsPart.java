 ...
 *@author sasahoo 
 */
public final class ChannelDetailsPart implements IFormPart, IPartSelectionListener {
 ...
 */	
	@SuppressWarnings("unchecked")
	public ChannelDetailsPart(IManagedForm mform, ScrolledPageBook pageBook) {
 ...
 */
	public ChannelDetailsPart(IManagedForm mform, Composite parent, int style) {
