...
public class ProjectDiagramPropertyLabelProvider extends LabelProvider {
	...
	public String getText(Object element) {
		...
		if (selElement instanceof TSEGraph) {
			...
			if (activeEditor instanceof ProjectDiagramEditor) {
				ProjectDiagramEditor editor = (ProjectDiagramEditor)activeEditor;
