...
/*
@author ssailapp
@date Apr 22, 2010 2:24:29 PM
 */

public class ProcUnitProtocolsTableProviderModel implements TableProviderModel {

	private ClusterConfigModelMgr modelmgr;
	private ProcessingUnit procUnit;

	public ProcUnitProtocolsTableProviderModel(ClusterConfigModelMgr modelmgr) {
	...
	public void addItem(Table table) {
		if (procUnit != null) {
			...
			String name = IdUtil.generateSequenceId("protocol", procUnit.httpProperties.ssl.protocols);
			item.setText(0, name);
		}
		updateModel(table);
	}
