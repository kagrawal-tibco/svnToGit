...
public class EntityDetailsPart implements IFormPart, IPartSelectionListener {
	...
	private String emptyDetailsInfoMessage;
 ...
 */	
	@SuppressWarnings("unchecked")
	public EntityDetailsPart(IManagedForm mform, ScrolledPageBook pageBook,String message) {
		this.pageBook = pageBook;
		emptyDetailsInfoMessage = message;
		pages = new Hashtable();
		initialize(mform);
	}
/**
 ...
 */
	public EntityDetailsPart(IManagedForm mform, Composite parent, int style,String message) {
		this(mform, mform.getToolkit().createPageBook(parent, style|SWT.V_SCROLL|SWT.H_SCROLL),message);
	}
/**
 ...
 */
	...
	private void createEmptyDetailsInfo(FormToolkit toolkit, Composite composite) {
		...
		txt	.setText(emptyDetailsInfoMessage, false, false);
