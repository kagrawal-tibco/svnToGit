...
public class ImportExcelDomainWizardPage extends WizardPage implements IDomainSourceWizardPage {
	...
	public ImportExcelDomainWizardPage(String pageName) {
		super(pageName);
		setTitle(Messages.getString("ImportDomainWizard.page.Title"));
		setDescription(Messages.getString("ImportDomainWizard.Desc"));
	}
