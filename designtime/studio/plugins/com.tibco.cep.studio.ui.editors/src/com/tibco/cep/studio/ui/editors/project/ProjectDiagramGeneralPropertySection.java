...
import static com.tibco.cep.studio.ui.diagrams.ProjectDiagramManager.PROCESS;
...
public class ProjectDiagramGeneralPropertySection extends AbstractPropertySection /*implements PaintObjectListener, VerifyListener, DisposeListener*/ {
	
	protected ProjectDiagramPropertySheetPage propertySheetPage;
...
//    private static final Image archives = EditorsUIPlugin.getDefault().getImage("icons/enterpriseArchive16x16.gif");
    ...
    private static final Image processes = EditorsUIPlugin.getDefault().getImage("icons/sequence_diagram.png");
...
//    private  final Image[] images = new Image[] {concepts,events,rules,rulefunctions, statemodels,archives,scoreCards,channels,destinations,decisionTables};
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		editor = (ProjectDiagramEditor) getPart();
	...
	public void createControls(Composite parent, TabbedPropertySheetPage tabbedPropertySheetPage) {
		...
		this.propertySheetPage = (ProjectDiagramPropertySheetPage) tabbedPropertySheetPage;
...
//		summaryText.addDisposeListener(this);
		...
		imagesMap.put(PROCESS, processes);
	}
 
	private void updateSummary() {
		((ProjectDiagramManager)editor.getDiagramManager()).buildProjectViewInfo(0, 0);
