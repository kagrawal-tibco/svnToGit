...
import com.jidesoft.decision.validation.impl.FieldValidationUtils;
import com.jidesoft.decision.validation.impl.MatchingValidationEntity;
...
public class TableModelColumnNameUpdateRequestListener implements ITableModelChangeRequestListener {
	...
	public <T extends ITableModelChangeRequestEvent> void doChange(T changeRequestEvent) {
		...
		DecisionField decisionField = (DecisionField)tableModelColumnUpdateRequestEvent.getSource();
		//Get event type
		...
		affectedColumn = allColumns.search(decisionField.getId());
	 ...
	 * @return
	 */
	private String getNewPropertyPath(String projectName, 
			                          Table tableEModel,
