...
import com.tibco.cep.decision.table.command.listeners.DecisionTableCellAdditionCommandListener;
...
public class DecisionTableAnalysisProblemResolution extends WorkbenchMarkerResolution implements
	...
	private DecisionRule createNewRule(String project,
		...
		ICommandCreationListener<AddCommand<TableRule>, TableRule> listener = 
			new DecisionTableAddRowCommandListener(decisionDataModel, tableEModel, TableTypes.DECISION_TABLE);
		int ruleIndex = 
	...
	private DecisionTableEditor openEditor(IMarker marker) throws Exception {
		IWorkbenchPage workbenchPage = 
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage();
		DecisionTableEditor decisionTableEditor = 
			(DecisionTableEditor)IDE.openEditor(workbenchPage, marker);
