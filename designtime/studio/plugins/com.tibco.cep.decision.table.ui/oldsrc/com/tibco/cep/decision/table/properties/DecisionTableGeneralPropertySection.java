...
import com.tibco.cep.decision.table.calendar.PropertyCalendar;
import com.tibco.cep.decision.table.calendar.PropertyCalendar.DatePropertyType;
...
/**
 * Handle updates to metadata of table from property section here.
 * @author sasahoo
 * @author aathalye	
 */
public class DecisionTableGeneralPropertySection extends AbstractDecisionTablePropertySection {
	...
	private void createGeneralTablePropertyPage(TabbedPropertySheetWidgetFactory widgetFactory) {
		...
		deleteEffDateButton.setImage(DTImages.getImage(DTImages.DT_IMAGES_CALANDAR_DELETE));
		...
		reffectiveDate.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				...
				String oldValue = "";
				if ((effectiveDateFeature = metaData.search(DecisionTableMetadataFeature.EXPIRY_DATE.getFeatureName())) != null) {
...
//		Button deleteEffDateButton = widgetFactory.createButton(composite, "", SWT.PUSH);
//		deleteEffDateButton.setImage(DTImages.getImage(DTImages.DT_IMAGES_CALANDAR_DELETE));
//		deleteEffDateButton.addSelectionListener(new SelectionAdapter() {
//			public void widgetSelected(SelectionEvent e) {
//				postDelete(reffectiveDate, DecisionTableMetadataFeature.EFFECTIVE_DATE.getFeatureName());
...
//		});
		...
		deleteTermDateButton.setImage(DTImages.getImage(DTImages.DT_IMAGES_CALANDAR_DELETE));
...
//		Button deleteTermDateButton = widgetFactory.createButton(composite, "",SWT.PUSH);
//		deleteTermDateButton.setImage(DTImages.getImage(DTImages.DT_IMAGES_CALANDAR_DELETE));
//		deleteTermDateButton.addSelectionListener(new SelectionAdapter() {
//			public void widgetSelected(SelectionEvent e) {
//				postDelete(rterminateDate, DecisionTableMetadataFeature.EXPIRY_DATE.getFeatureName());
...
//		});
	...
	private void postDelete(Text text, String propertyName){
		if (tableEModel != null) {
//			MetaData metaData = tableEModel.getMd();
//			if (metaData.search(propertyName) != null) {
//				metaData.search(propertyName).setValue("");
//			}
			Property effectiveDateFeature = null;
			MetaData metaData = tableEModel.getMd();
			String oldValue = "";
...
//						Date date = IPropertyViewConstants.persistedSdf.parse(value);
//						reffectiveDate.setText(IPropertyViewConstants.sdf.format(date));
				...
				if ((expiryDateFeature = metaData.search(DecisionTableMetadataFeature.EXPIRY_DATE.getFeatureName())) != null) {
					...
					if (value != null && !value.equalsIgnoreCase("")) {
//						Date date = IPropertyViewConstants.persistedSdf.parse(value);
//						rterminateDate.setText(IPropertyViewConstants.sdf.format(date));
