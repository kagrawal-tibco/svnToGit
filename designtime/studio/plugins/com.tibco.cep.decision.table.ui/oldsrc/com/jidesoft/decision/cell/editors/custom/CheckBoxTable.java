...
public class CheckBoxTable extends JList {
	...
	protected CheckBoxTableCellRenderer _listCellRenderer;
	...
	protected List<JRadioButton> rButtonlist = new ArrayList<JRadioButton>();

	public List<JRadioButton> getRButtonlist() {
		return rButtonlist;
	}
	 ...
	 */
	public CheckBoxTable(final Vector<?> listData) {
		super(listData);
		init();
	}
	 ...
	 * @param listData the <code>Vector</code> to be loaded into the data model
	 */
	public CheckBoxTable(final Vector<?> listData,ConverterContext context) {
		super(listData);
	 ...
	 */
	public CheckBoxTable(final Object[] listData) {
		super(listData);
		init();
	}
	 ...
	 */
	public CheckBoxTable(ListModel dataModel) {
		super(dataModel);
		init();
	}
	 ...
	 */
	protected CheckBoxTableCellRenderer createCellRenderer() {
		rButtonlist.clear();
		return new CheckBoxTableCellRenderer(null, context, this);
	}
	...
	protected static class Handler implements MouseListener, KeyListener, ListSelectionListener, PropertyChangeListener, ListDataListener {
		protected CheckBoxTable _list;
		int hotspot = new JCheckBox().getPreferredSize().width;


		public Handler(CheckBoxTable list) {
			_list = list;
		}
	 ...
	 */
	 ...
	 public Object[] getCheckBoxListSelectedValues() {
		 ...
		 if (context instanceof DefaultConverterContext) {
			 String[] values = ((DefaultConverterContext)context).getValues();//getDescriptions();
			 act = values;
		 }
	 ...
	 public Object[] getCheckBoxListSelectedOtherColumnValues() {
		 ListSelectionModel listSelectionModel = getCheckBoxListSelectionModel();
	 ...
	 public Object[] getExpressionValues() {
		 return getCheckBoxListSelectedOtherColumnValues();
	 }
