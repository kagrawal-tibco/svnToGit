 ...
 *
 */
public class DecisionTableAnalyzerConstants {
	public static final String ANALYZE_FIXABLE_MARKER_NAME = DecisionTableUIPlugin.PLUGIN_ID + ".analyzeProblem";
	public static final String ANALYZE_RULECOMB_MARKER_NAME = DecisionTableUIPlugin.PLUGIN_ID + ".analyzeCombinationProblem";
	public static final String ANALYZE_GENERAL_MARKER_NAME = DecisionTableUIPlugin.PLUGIN_ID + ".analyzeGeneralProblem";
