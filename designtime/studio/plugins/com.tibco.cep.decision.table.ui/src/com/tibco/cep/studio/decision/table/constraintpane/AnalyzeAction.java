...
import com.tibco.cep.studio.decision.table.ui.job.AnalyzeTableJob;
...
public class AnalyzeAction extends Action {
	...
	public void run() {
		...
		AnalyzeTableRunnable runnable = createAnalysisRunnable(useDomainModel);
    ...
    protected AnalyzeTableRunnable createAnalysisRunnable(boolean useDomainModel) {
        return new AnalyzeTableRunnable(fAnalyzerView.getCurrentOptimizedTable(), 
				getTable(),
				useDomainModel,
	...
	protected Table getTable() {
		IDecisionTableEditor editor = fAnalyzerView.getCurrentEditor();
		if (editor != null) {
