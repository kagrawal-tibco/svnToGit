...
import com.tibco.cep.security.authz.core.impl.ACLManagerStudioCache;
...
public class SecurityPlugin extends Plugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.tibco.cep.security";
	...
	public void start(BundleContext context) throws Exception {
		...
		ACLManagerStudioCache aclManagerCache = ACLManagerStudioCache.INSTANCE;
		ResourcesPlugin.getWorkspace().addResourceChangeListener(aclManagerCache, IResourceChangeEvent.POST_CHANGE);
