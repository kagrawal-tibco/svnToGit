...
public class HawkRefactoringParticipant extends AbstractSharedResourceRefactoring {
	public Change createPreChange(IProgressMonitor pm) throws CoreException, OperationCanceledException {
		...
		if ((resource instanceof IFolder)) {
			...
			return processHawkConfig(elementToRefactor, this.fProjectName, pm);
		}
		...
		processHawkConfigElement(this.fProjectName, change, file, modelmgr, elementToRefactor);
		return change;
	}
	...
	public Change processHawkConfig(Object elementToRefactor, String projectName, IProgressMonitor pm)
		...
		CompositeChange compositeChange = new CompositeChange("Hawk Configuration changes:");
		...
		for (IFile element : fileList) {
			...
			HawkModelMgr modelmgr = new HawkModelMgr(element);
			modelmgr.parseModel();
			processHawkConfigElement(this.fProjectName, compositeChange, element, modelmgr, elementToRefactor);
		}
	...
	public String getName() {
		return "Hawk Configuration Refactoring participant";
	}

	private void processHawkConfigElement(String projectName, CompositeChange compositeChange, IFile sharedFile,
			HawkModelMgr modelmgr, Object elementToRefactor) throws CoreException {
