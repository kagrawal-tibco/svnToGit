 ...
 * @author rgupta
 */
public class ViewEditor extends AbstractDBFormEditor {

	@Override
	protected void addPages() {
		try {
			addPage(new ViewPage(this, getLocalElement()));
	...
	protected String[] getInterestingElementTypes() {
		return new String[] { BEViewsElementNames.SKIN, BEViewsElementNames.DASHBOARD_PAGE };
	}
