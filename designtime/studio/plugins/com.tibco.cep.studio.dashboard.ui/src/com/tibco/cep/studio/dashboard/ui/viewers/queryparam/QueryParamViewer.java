 ...
 * @ *
 */
public class QueryParamViewer extends AttributeViewer implements ISynElementChangeListener {

	public static final Logger LOGGER = Logger.getLogger(QueryParamViewer.class.getName());
	 ...
	 * @param parent
	 */
	public QueryParamViewer(FormToolkit toolKit, Composite parent) {
	...
	public void createTable(Composite parent) {
		...
		setColumnNames(new String[] { STATUS_COLUMN, NAME_COLUMN, DATATYPE_COLUMN });

		int style = SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION | SWT.SINGLE;
