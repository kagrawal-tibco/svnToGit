 ...
 * @author rgupta
 */
public class SkinEditor extends AbstractDBFormEditor {

	@Override
	protected void addPages() {
		try {
			addPage(new SkinPage(this, getLocalElement()));
	...
	protected String[] getInterestingElementTypes() {
		return new String[] { BEViewsElementNames.CHART_COLOR_SET, BEViewsElementNames.TEXT_COLOR_SET };
	}
