 ...
 * @author rgupta
 */
public class PageEditor extends AbstractDBFormEditor {

    @Override
	protected void addPages() {
        try {
            addPage(new PagePage(this, getLocalElement()));
	...
	protected String[] getInterestingElementTypes() {
		return new String[] { BEViewsElementNames.CHART_COMPONENT, BEViewsElementNames.TEXT_COMPONENT };
	}
