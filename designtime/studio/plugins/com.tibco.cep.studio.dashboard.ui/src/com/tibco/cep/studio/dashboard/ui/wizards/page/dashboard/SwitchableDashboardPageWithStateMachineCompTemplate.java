...
public class SwitchableDashboardPageWithStateMachineCompTemplate extends PageTemplate {

	public SwitchableDashboardPageWithStateMachineCompTemplate() {
		super("Switchable Dashboard Page With State Model Component",
				"Template to create a dashboard page which contains a page selector component, a state model component and charts"
				,new SwitchableDashboardPageWithStateMachineCompWizardPage("Switchable Dashboard Page"));
	}
	...
	public List<LocalEntity> buildPage(IProject project, LocalPage page) throws Exception {
		SwitchableDashboardPageWithStateMachineCompWizardPage myPage = (SwitchableDashboardPageWithStateMachineCompWizardPage) super.wizardPage;
		...
		//add state model component & charts partition
		LocalPartition chartsPartition = (LocalPartition) page.createLocalElement(BEViewsElementNames.PARTITION);
		chartsPartition.setName("OtherComponentsPartition");
		chartsPartition.setDisplayName("Other Components Partition");
		chartsPartition.setPropertyValue("SpanPercentage", (100-myPage.getPageSwitcherSpan())+"%");
		// add a panel for the state model component
		LocalPanel smcPanel = (LocalPanel) chartsPartition.createLocalElement(BEViewsElementNames.PANEL);
