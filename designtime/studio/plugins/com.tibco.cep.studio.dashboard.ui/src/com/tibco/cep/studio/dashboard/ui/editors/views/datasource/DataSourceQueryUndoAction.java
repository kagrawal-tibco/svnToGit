...
public class DataSourceQueryUndoAction extends Action {

	private DataSourceEditor targetEditor;

	public DataSourceQueryUndoAction(IEditorPart targetEditor) {
	...
	public void run() {
		...
		if (page.getQueryTextViewer().getTextWidget().isFocusControl() == true){
			page.getQueryTextViewer().getUndoManager().undo();
		}
	}
