...
public class IndexFormatMarkerResolution implements IMarkerResolution2, ModelChangeListener {
	...
	public String getDescription() {
		return BpmnMessages.getString("indexFormatMarkerReso_description_label");
	}
	...
	public String getLabel() {
		return Messages.getString("process.validate.quickfix.oldkey");
	}
...
//				options.put(XMIResource.OPTION_SKIP_ESCAPE_URI, true);
				...
				try {
					resource.getProject().build(IncrementalProjectBuilder.FULL_BUILD, new NullProgressMonitor());
