...
public class GatewayCommandFactory extends AbstractNodeCommandFactory {

	public GatewayCommandFactory(IProject proj, ModelController controller,EClass type,ENamedElement extType) {
	...
	public IGraphCommand<TSENode> getInsertCommand(TSEGraph graph, TSENode node) {
		return new GatewayInsertCommand(IGraphCommand.COMMAND_ADD,
	...
	public IGraphCommand<TSENode> getDeleteCommand(TSEGraph graph, TSENode node) {
		return new GatewayDeleteCommand(IGraphCommand.COMMAND_DELETE,
...
//				String label = (String) node.getAttributeValue(BpmnUIConstants.NODE_ATTR_LABEL);
				...
				AbstractNodeUIFactory nodeBuilder = BpmnGraphUIFactory
						.getInstance(null).getNodeUIFactory(null,attachedRes, toolId, nType,
								classSpec);
				...
				modelCmd = new GatewayGeneralPropertiesUpdateCommand(IGraphCommand.COMMAND_UPDATE,
