...
public class SequenceReconnectCommand extends TSEReconnectEdgeCommand implements
	...
	public SequenceReconnectCommand(ModelController modelController,
			TSEEdge paramTSEEdge, TSENode paramTSENode,
			TSEConnector paramTSEConnector, boolean paramBoolean,
	...
	protected void undoAction() throws Throwable {
		...
		if(mustReconnectSource()){
			...
			getModelController().updateGatewayDirection(oldNode);
		}
		else{
	...
	private void createEmfModel(){
		...
		if(mustReconnectSource()){
			...
			getModelController().updateGatewayDirection(node);
			getModelController().updateGatewayDirection(oldNode);
		}
		else{
