 ...
 *
 */
public class TaskDeleteCommand extends FlowElementDeleteCommand {
	
	private static final long serialVersionUID = -5153227946688282380L;

	public TaskDeleteCommand(int commandAdd, ModelController modelController,EClass modelType, ENamedElement extType,TSENode node) {
