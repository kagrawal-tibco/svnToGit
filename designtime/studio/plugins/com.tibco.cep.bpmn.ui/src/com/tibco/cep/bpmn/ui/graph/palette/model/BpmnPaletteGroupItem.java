...
import com.tibco.cep.bpmn.common.palette.model.BpmnCommonPaletteGroupJavaItemType;
import com.tibco.cep.bpmn.common.palette.model.BpmnCommonPaletteGroupModelItemType;
 ...
 *
 */
public  class BpmnPaletteGroupItem extends BpmnPaletteItemTypeInfo {
	BpmnCommonPaletteGroupItemType itemType;
	private BpmnPaletteGroup parent;
	private PaletteEntry entry;

	public BpmnPaletteGroupItem(BpmnPaletteGroup parent, PaletteItem item) {
		super(item);
		this.parent=parent;
		initializeItemType();
	}
	...
	public BpmnPaletteGroup getParentBpmnPaletteGroup(){
		return parent;
	}

	
	public void setParentBpmnPaletteGroup(BpmnPaletteGroup group){
		parent = group;
	}
