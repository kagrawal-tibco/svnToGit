 ...
 *
 */
public class PaletteHelpmessages {
	
	private PaletteHelpmessages(){
		
	}

	private static final String         BUNDLE_NAME     = "com.tibco.cep.bpmn.ui.graph.palette.PaletteHelp"; //$NON-NLS-1$
