 ...
 *
 */
public class WebServiceMapperHelper {
	private final static MutableComponentFactoryTNS mcf = DefaultComponentFactory.getTnsAwareInstance();
	private EntityMapperContext mctx;
	private AbstractMapperControl mapperControl;
	private IProject fProject;

	public WebServiceMapperHelper(IProject project , EntityMapperContext context , AbstractMapperControl control){
		this.fProject = project;
		this.mctx = context;
		this.mapperControl=control;
	}
	
	private AbstractMapperControl getMapper(){
		return mapperControl;
	}
	
	public SmElement buildOutputSoapSchema(
				...
				if (addDataExtensionValueWrapper != null) {
					...
					if (operationRef != null) {
						try {
							...
							createSoapSchema = createSoapSchema(schema,	payloadElement, WsMessageKind.OUTPUT);
						} catch (Exception e) {
							BpmnUIPlugin.log(e);
						}
	...
	public void buildInputSoapSchema(
			EObjectWrapper<EClass, EObject> webServiceTask, String xslt) {
		WsSchemaBuilder schemaBuilder = new WsSchemaBuilder();
		String attachedResource = (String) BpmnModelUtils
				.getAttachedResource(webServiceTask.getEInstance());
    ...
    public MutableSchema getSchema(String ns) {
	...
	public void buildSoapSchema(WsSchemaBuilder builder,
	...
	public MutableElement createSoapSchema(MutableSchema schema, MutableElement ele, WsMessageKind kind) {
...
//        		MutableSupport.addLocalElement(onType, localName, mutableType, min, max);
    ...
    private static void addSoapHeaderAttribs(MutableType onType) {
    	MutableSupport.addAttribute(onType, BpmnMessages.getString("mutableSupport.attribute1"), XSDL.INT, false);
    	MutableSupport.addAttribute(onType,  BpmnMessages.getString("mutableSupport.attribute2"), XSDL.STRING, false);
    }
...
//    }
	...
	public class WsSchemaBuilder extends SOAPEventPayloadBuilder{
