...
import com.tibco.cep.bpmn.common.palette.model.BpmnCommonPaletteItemTypeInfo;
 ...
 *
 */
public class BpmnPaletteItemTypeInfo extends BpmnCommonPaletteItemTypeInfo{

	
	protected PaletteItem item;

	public BpmnPaletteItemTypeInfo( PaletteItem item) {
		super(item);
		this.item = item;
		if(isRef()){
