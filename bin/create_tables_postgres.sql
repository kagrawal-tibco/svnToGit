/******************************************************************************
    ...
    PostgreSQL persistence of BusinessEvents® working memory objects
 *****************************************************************************/

/** This table stores all the mappings between BE classes (full generated path) and corresponding PostgreSQL tables*/
...
CREATE TABLE WorkItems (workKey varchar(2000), workQueue varchar(255), workStatus BIGINT, scheduledTime BIGINT, work bytea);

CREATE INDEX i_WorkItems on WorkItems (workQueue, scheduledTime);
-- Postgres has index key length limitation (2730 bytes)
